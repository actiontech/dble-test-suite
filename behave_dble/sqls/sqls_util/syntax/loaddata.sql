...
##github #774
drop table if exists test1
create table test1(id int, c1 char(5), c2 char(5), c3 char(5)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
load data infile "./test4.txt" replace into table test1 character set 'utf8' fields terminated by ',' lines terminated by '\n' (id,c1) set c2='c2', c3='c3';
