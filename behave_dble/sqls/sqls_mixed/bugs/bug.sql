...
#github issues:2030
drop table if exists sharding_4_t1
create table sharding_4_t1(col1 varchar(15),col2 varchar(15),col3 varchar(15), col4 varchar(15),col5 varchar(15),col6 varchar(15),col7 varchar(15),col8 varchar(15)) DEFAULT CHARSET=utf8mb4
