...
-- CHANGE MASTER TO MASTER_LOG_FILE='mysql-bin.000004', MASTER_LOG_POS=9815;
...
--
-- Temporary view structure for view `vvview`
--

DROP TABLE IF EXISTS `vvview`;
/*!50001 DROP VIEW IF EXISTS `vvview`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vvview` AS SELECT
 1 AS `id`,
 1 AS `name`,
 1 AS `age`*/;
...
--
-- Final view structure for view `vvview`
--
...
/*!50001 VIEW `vvview` AS select `nosharding`.`id` AS `id`,`nosharding`.`name` AS `name`,`nosharding`.`age` AS `age` from `nosharding` */;
...
-- Dump completed on 2022-05-18 15:36:39
