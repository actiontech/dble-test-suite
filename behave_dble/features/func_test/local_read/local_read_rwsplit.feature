...
Feature: check dbDistrict and dbDataCenter
  ...
  Scenario: bootstrap.cnf and db.xml only set district #1
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                         | db  | expect                 |
       | rwS1  | 111111 | conn_1 | true    | select id,name from table_1 | db1 | Unknown database 'db1' |
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                          | db  | expect      |
       | rwS1  | 111111 | conn_1 | true    | select name,age from table_1 | db1 | length{(4)} |
    Then check general log in host "mysql-master2" has "select name,age from table_1"
    Then check general log in host "mysql-slave1" has not "select name,age from table_1"
    Then check general log in host "mysql-slave2" has not "select name,age from table_1"
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                                     | db  | expect                |
       | rwS1  | 111111 | conn_1 | true    | select name,age from table_1 where id=1 | db1 | has{(('name1', 18),)} |
    Then check general log in host "mysql-master2" has not "select name,age from table_1 where id=1"
  ...
  Scenario: bootstrap.cnf and db.xml only set dataCenter, local read is not enabled #2
    ...
    Given execute sql in "dble-1" in "user" mode
       ...
       | rwS1  | 111111 | conn_1 | false   | select sleep(1)                                                       | db1 | success |
       | rwS1  | 111111 | conn_1 | false   | select * from table_2                                                 | db1 | length{(2)} |
  Then check general log in host "mysql-master2" has not "select sleep(1)"
  Then check general log in host "mysql-master2" has not "select \* from table_2"
  Then check general log in host "mysql-slave1" has not "select sleep(1)"
  Then check general log in host "mysql-slave1" has not "select \* from table_2"
    Then check general log in host "mysql-slave2" has "select sleep(1)"
  ...
  Scenario: bootstrap.cnf and db.xml set district and dataCenter #3
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                         | db  | expect                 |
       | rwS1  | 111111 | conn_1 | true    | select id,name from table_3 | db1 | Unknown database 'db1' |
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                                     | db  | expect                |
       | rwS1  | 111111 | conn_1 | true    | select name,age from table_3 where id=1 | db1 | has{(('name1', 18),)} |
    Then check general log in host "mysql-master2" has "select name,age from table_3 where id=1"
    Then check general log in host "mysql-slave1" has not "select name,age from table_3 where id=1"
    Then check general log in host "mysql-slave2" has not "select name,age from table_3 where id=1"
    ...
    Given execute sql in "dble-1" in "user" mode
       | user  | passwd | conn   | toClose | sql                                     | db  | expect                |
       | rwS1  | 111111 | conn_1 | true    | select name,age from table_3 where id=3 | db1 | has{(('name3', 30),)} |
    Then check general log in host "mysql-master2" has not "select name,age from table_3 where id=3"
  ...
  Scenario: check rwStickyTime and local read #4
    ...
    Given execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql                                                                   | db  | expect  |
      | rwS1  | 111111 | conn_1 | false   | drop table if exists table_4                                          | db1 | success |
      | rwS1  | 111111 | conn_1 | false   | create table table_4 (id int, name varchar(100), age int)             | db1 | success |
      | rwS1  | 111111 | conn_1 | false   | insert into table_4 values (1,'name1',18),(2, 'name2',20),(3,'name3',30),(4,'name4',19) | db1 | success |
      | rwS1  | 111111 | conn_1 | false   | select name from table_4                                              | db1 | has{(('name1',),('name2',),('name3',),('name4',))} |
      | rwS1  | 111111 | conn_1 | true    | drop table if exists table_4                                          | db1 | success |
    Then check general log in host "mysql-master2" has "select name from table_4"
    Then check general log in host "mysql-slave1" has not "select name from table_4"
    Then check general log in host "mysql-slave2" has not "select name from table_4"
    Given turn off general log in "mysql-master2"
    Given turn off general log in "mysql-slave1"
    Given turn off general log in "mysql-slave2"