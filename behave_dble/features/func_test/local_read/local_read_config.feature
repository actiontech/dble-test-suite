...
Feature: check dbDistrict and dbDataCenter
  ...
  Scenario: check dbDistrict and dbDataCenter value #1
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | select * from dble_config                                                                                  | dble_information | hasNoStr{dbDistrict},hasNoStr{dbDataCenter} |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                          | db               | expect      |
      | conn_0 | false   | select * from dble_config                                    | dble_information | hasStr{"name":"hostM1","url":"172.100.9.5:3306","password":"111111","user":"test","maxCon":100,"minCon":20,"primary":true,"dbDistrict":"abc","dbDataCenter":"123"},hasStr{"name":"hostM2","url":"172.100.9.6:3306","password":"111111","user":"test","maxCon":100,"minCon":20,"primary":true,"dbDistrict":"ABC_123","dbDataCenter":"Def-456"} |
    ...
    """
    db json to map occurred  parse errors, The detailed results are as follows . com.actiontech.dble.config.util.ConfigException: property \[ dbDistrict \]  is illegal, the value not be empty
    """
    Given add xml segment to node with attribute "{'tag':'root'}" in "db.xml"
    """
    <dbGroup rwSplitMode="1" name="ha_group2" delayThreshold="100">
    ...
    Then restart dble in "dble-1" failed for
    """
    db json to map occurred  parse errors, The detailed results are as follows . com.actiontech.dble.config.util.ConfigException: property \[ dbDataCenter \]  is illegal, the value not be empty
    """
...
#    Given update file content "/opt/dble/conf/bootstrap.cnf" in "dble-1" with sed cmds
#    """
#    /-Ddistrict=/c -Ddistrict=123@abc
#    /-DdataCenter=/c -DdataCenter=456+def
#    """
#    Then restart dble in "dble-1" failed for
#    """
...
#    """
    ...
    Given update file content "/opt/dble/conf/bootstrap.cnf" in "dble-1" with sed cmds
    """
    /-Ddistrict=/c -Ddistrict=Shanghai
  ...
  Scenario: check Chinese value #2
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                          | db               | expect      |
      | conn_0 | false   | select * from dble_config                                    | dble_information | hasStr{"name":"hostM1","url":"172.100.9.5:3306","password":"111111","user":"test","maxCon":100,"minCon":20,"primary":true,"dbDistrict":"上海abc","dbDataCenter":"徐汇123"},hasStr{"name":"hostM2","url":"172.100.9.6:3306","password":"111111","user":"test","maxCon":100,"minCon":20,"primary":true,"dbDistrict":"浙江_Ab-12","dbDataCenter":"杭州-cD_34"} |
