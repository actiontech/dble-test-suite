...
# Created by wangjuan at 2022/6/10
Feature: check joinStrategyType sql plan

  @delete_mysql_tables
  Scenario: check joinStrategyType left join & inner join - shardingTable + shardingTable + shardingTable #1
  """
  ...
  """
    ...
    #ab, ac: left join & inner join & one ER & no where => table c nestLoop
    ...
    #ab, ac: left join & inner join & one ER & no where => b,c nestLoop
    ...
    #ab, ac: left join & inner join & no ER & no where => b,c nestLoop
    ...
    #ab, bc: inner join & left join & one ER & no where => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: inner join & left join & one ER & no where => b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: inner join & left join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_3"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where b => table a,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & one ER & where c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where a.empid=3401 and c.age=25 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 3401 ORDER BY `a`.`name` ASC                                                        |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 3401 ORDER BY `a`.`name` ASC                                                        |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where a.empid=3401 and c.age=25 order by a.name | schema1 |
    #ab, ac: inner join & left join & one ER & where b,c => table a nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where b.deptid=2 and c.age=25 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                                  |
      | dn1_0             | BASE SQL              | select `b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Dept` `b` where `b`.`deptid` = 2 ORDER BY `b`.`manager` ASC                                                                         |
      | dn2_0             | BASE SQL              | select `b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Dept` `b` where `b`.`deptid` = 2 ORDER BY `b`.`manager` ASC                                                                         |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where b.deptid=2 and c.age=25 order by a.name | schema1 |
    #ab, ac: inner join & left join & one ER & where a,b,c => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where a.empid=3401 and b.deptid=2 and c.age=25 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                                      |
      | dn1_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 3401 ORDER BY `a`.`name` ASC |
      | dn2_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 3401 ORDER BY `a`.`name` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname where a.empid=3401 and b.deptid=2 and c.age=25 order by a.name | schema1 |


    #ab, ac: inner join & left join & no ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & no ER & where b => table a,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: inner join & left join & no ER & where b,c => table a nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & one ER & where a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & one ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & one ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & one ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & one ER & where c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & no ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & no ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_3"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & no ER & where c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_3"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, bc: left join & inner join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=2202 and b.deptid=3 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                          |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                          |
    ...
    # ab, ac: left join & inner join & no ER & where a & on and b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, ac: left join & inner join & no ER & where a & on or b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: inner join & left join & no ER & where b & on and a => table a,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: inner join & left join & no ER & where c & on and b => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: inner join & left join & no ER & where a & on or a => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: inner join & left join & no ER & where a or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: inner join & left join & no ER & where a or b or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, ac: inner join & left join & one ER & no where & on and b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname and b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1       |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1       |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname and b.deptid=2 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or b => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname or b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
      | dn2_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname or b.deptid=2 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on and c => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname and c.salary=15000 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
      | dn2_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname and c.salary=15000 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or c => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname or c.salary=15000 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
      | dn2_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Level c on a.level=c.levelname or c.salary=15000 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on and bc => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Info c on a.name=c.name and b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1                  |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1                  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Info c on a.name=c.name and b.manager=c.name order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or bc => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Info c on a.name=c.name or b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0 | TYPE-1        | SQL/REF-2                                                                                                              |
      | dn1_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
      | dn2_0           | BASE SQL      | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.deptname=b.deptname LEFT JOIN Info c on a.name=c.name or b.manager=c.name order by a.name | schema1 |


    # ab, ac: inner join & left join & one ER & no where & on and b => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                           |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                           |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and b.deptid=2 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or b => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or b.deptid=2 order by a.name | schema1 |
    #ab, ac: inner join & left join & one ER & no where & on and c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and c.age=25 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and c.age=25 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a  INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or c.age=25 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a  INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or c.age=25 order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on and bc => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                                          |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                                          |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname and b.manager=c.name order by a.name | schema1 |
    # ab, ac: inner join & left join & one ER & no where & on or bc => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.deptname=c.deptname or b.manager=c.name order by a.name | schema1 |


    # ab, ac: inner join & left join & no ER & no where & on and b => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname and b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                       |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                       |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname and b.deptid=2 order by a.name | schema1 |
    # ab, ac: inner join & left join & no ER & no where & on or b => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname or b.deptid=2 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname or b.deptid=2 order by a.name | schema1 |
    # ab, ac: inner join & left join & no ER & no where & on and c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname and c.salary=15000 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname and c.salary=15000 order by a.name | schema1 |
    # ab, ac: inner join & left join & no ER & no where & on or c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname or c.salary=15000 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Level c on a.level=c.levelname or c.salary=15000 order by a.name | schema1 |
    # ab, ac: inner join & left join & no ER & no where & on and bc => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.name=c.name and b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                                  |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                                  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.name=c.name and b.manager=c.name order by a.name | schema1 |
    # ab, ac: inner join & left join & no ER & no where & on or bc => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.name=c.name or b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a INNER JOIN Dept b on a.name=b.manager LEFT JOIN Info c on a.name=c.name or b.manager=c.name order by a.name | schema1 |


    # ab, bc: left join & inner join & one ER & no where & on and a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name and a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where `a`.`empid` = 2202 ORDER BY `b`.`manager` ASC |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where `a`.`empid` = 2202 ORDER BY `b`.`manager` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name and a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & one ER & no where & on or a => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name or a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name or a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & one ER & no where & on and c => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name and c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  ORDER BY `b`.`manager` ASC |
      | dn2_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  ORDER BY `b`.`manager` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name and c.age=35 order by a.name | schema1 |
    # ab, bc: left join & inner join & one ER & no where & on or c => no nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name or c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  ORDER BY `a`.`name` ASC |
      | dn2_0             | BASE SQL        | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level`,`b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Employee` `a` left join  `Dept` `b` on `a`.`deptname` = `b`.`deptname` where 1=1  ORDER BY `a`.`name` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on b.manager=c.name or c.age=35 order by a.name | schema1 |


    # ab, bc: left join & inner join & one ER & no where & on and a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname and a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1          | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                                  |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                                  |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname and a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & one ER & no where & on or a => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname or a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname or a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & one ER & no where & on and c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname and c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname and c.age=35 order by a.name | schema1 |
    # ab, ac: left join & inner join & one ER & no where & on or c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname or c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.deptname=c.deptname or c.age=35 order by a.name | schema1 |


    # ab, bc: left join & inner join & no ER & no where & on and a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                          |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` where `a`.`empid` = 2202 ORDER BY `a`.`name` ASC                                                          |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & no ER & no where & on or a => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or a.empid=2202 order by a.name | schema1 |
    # ab, bc: left join & inner join & no ER & no where & on and c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                                              |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and c.age=35 order by a.name | schema1 |
    # ab, bc: left join & inner join & no ER & no where & on or c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      | SHARDING_NODE-0   | TYPE-1                | SQL/REF-2                                                                                             |
      | dn1_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
      | dn2_0             | BASE SQL              | select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee` `a` ORDER BY `a`.`name` ASC                                                                                 |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee a LEFT JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or c.age=35 order by a.name | schema1 |