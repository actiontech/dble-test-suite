...
#      | merge_and_order_1 | MERGE_AND_ORDER       | dn1_0; dn2_0                                                                                                                                                                      |
#      | shuffle_field_1   | SHUFFLE_FIELD         | merge_and_order_1                                                                                                                                                                 |
#      | dn4_0             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `c`.`country`,`c`.`name` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC,`c`.`name` ASC     |
#      | merge_1           | MERGE                 | dn4_0                                                                                                                                                                             |
#      | join_1            | JOIN                  | shuffle_field_1; merge_1                                                                                                                                                          |
#      | shuffle_field_2   | SHUFFLE_FIELD         | join_1                                                                                                                                                                            |
#    Then execute sql in "dble-1" and the result should be consistent with mysql
...
#      | conn_0 | true    | /*#dble:plan=(b,a)\|c*/SELECT a.name,a.deptname,b.manager,c.country FROM  Employee a INNER JOIN Dept b on a.deptname=b.deptname INNER JOIN Info c on a.name=c.name and b.manager=c.name order by a.name; | schema1 |
    ...
    Then check resultset "rs_67" has lines with following column values
      ...
      | order_1           | ORDER                 | join_1                                                                                                                                                                                       |
      | shuffle_field_2   | SHUFFLE_FIELD         | order_1                                                                                                                                                                                      |
      | dn1_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager`,`b`.`deptname` from  `Dept` `b` where `b`.`deptname` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`deptname` ASC,`b`.`manager` ASC |
      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager`,`b`.`deptname` from  `Dept` `b` where `b`.`deptname` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`deptname` ASC,`b`.`manager` ASC |
      | merge_and_order_2 | MERGE_AND_ORDER       | dn1_1; dn2_1                                                                                                                                                                                 |
      | shuffle_field_4   | SHUFFLE_FIELD         | merge_and_order_2                                                                                                                                                                            |
...
#      | order_1           | ORDER                 | join_1                                                                                                                                                                      |
#      | shuffle_field_2   | SHUFFLE_FIELD         | order_1                                                                                                                                                                     |
#      | dn1_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC,`b`.`manager` ASC |
#      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC,`b`.`manager` ASC |
#      | merge_and_order_2 | MERGE_AND_ORDER       | dn1_1; dn2_1                                                                                                                                                                |
#      | shuffle_field_4   | SHUFFLE_FIELD         | merge_and_order_2                                                                                                                                                           |
#      | join_2            | JOIN                  | shuffle_field_2; shuffle_field_4                                                                                                                                            |
#      | shuffle_field_3   | SHUFFLE_FIELD         | join_2                                                                                                                                                                      |
...
#      | dn3_0//dn4_0             | BASE SQL              | select `c`.`country`,`c`.`name` from  `Info` `c` order by `c`.`name` ASC                                                                                                           |
#      | merge_1           | MERGE                 | dn3_0//dn4_0                                                                                                                                                                              |
#      | dn1_0             | BASE SQL              | select `b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC                                                                      |
#      | dn2_0             | BASE SQL              | select `b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC                                                                      |
#      | merge_and_order_1 | MERGE_AND_ORDER       | dn1_0; dn2_0                                                                                                                                                                       |
#      | shuffle_field_3   | SHUFFLE_FIELD         | merge_and_order_1                                                                                                                                                                  |
#      | join_1            | JOIN                  | merge_1; shuffle_field_3                                                                                                                                                           |
#      | order_1           | ORDER                 | join_1                                                                                                                                                                             |
...
# inner join & inner join & 1 er & ab, ac bc
    ...
    Then check resultset "rs_67" has lines with following column values
      ...
      | order_1           | ORDER                 | join_1                                                                                                                                                                                                                |
      | shuffle_field_2   | SHUFFLE_FIELD         | order_1                                                                                                                                                                                                               |
      | dn1_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager`,`b`.`deptname` from  `Dept` `b` where  ( `b`.`deptid` = 3 AND `b`.`deptname` in ('{NEED_TO_REPLACE}')) ORDER BY `b`.`deptname` ASC,`b`.`manager` ASC |
      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`manager`,`b`.`deptname` from  `Dept` `b` where  ( `b`.`deptid` = 3 AND `b`.`deptname` in ('{NEED_TO_REPLACE}')) ORDER BY `b`.`deptname` ASC,`b`.`manager` ASC |
      | merge_and_order_2 | MERGE_AND_ORDER       | dn1_1; dn2_1                                                                                                                                                                                                          |
      | shuffle_field_4   | SHUFFLE_FIELD         | merge_and_order_2                                                                                                                                                                                                     |
      | join_2            | JOIN                  | shuffle_field_2; shuffle_field_4                                                                                                                                                                                      |
      | order_2           | ORDER                 | join_2                                                                                                                                                                                                                |
