...
# Created by quexiuping 2020/10/29

Feature: Optimize Query Plan which can be sent to one shardingNode in fact   from testlink and  https://github.com/actiontech/dble/issues/752
   ...
   Scenario: execute "explain sql" and check result
    ...
    <schema shardingNode="dn5" name="schema1" sqlMaxLimit="100">
      ...
      <shardingTable name="a_three" shardingNode="dn1,dn2,dn3" function="hash-three" shardingColumn="id"/>
      ...
      <shardingTable name="a_manager" shardingNode="dn2,dn1,dn3,dn4" function="hash-four" shardingColumn="id"/>
   ...
   """
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | true    | insert into a_three values(1,'a'),(null,'b'),(9,'b'),(10,'c'),(11,'d')                 | success | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                   | db      |
      | conn_0 | False   | explain select count(*) from aly_test a where a.id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                       | db      |
      | conn_0 | False   | explain select id a from sharding_two_node b where b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_4"
      | conn   | toClose | sql                                                                          | db      |
      | conn_0 | False   | explain select count(*) from aly_test a where a.c='a' or a.c='b' and a.id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_5"
      | conn   | toClose | sql                                                               | db      |
      | conn_0 | False   | explain select count(*) from aly_test a where a.id =1 group by id | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_6"
      | conn   | toClose | sql                                                                                                          | db      |
      | conn_0 | False   | explain select * from aly_order join test_global where aly_order.id in ( select id from aly_test where id=1) | schema1 |
    Then check resultset "rs_6" has lines with following column values
      ...
      #| dn3_1                      | BASE SQL                 | select `test_global`.`id`,`test_global`.`cc` from  `test_global`                                                              |
      #| merge_1                    | MERGE                    | dn3_1                                                                                   |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_7"
      | conn   | toClose | sql                                                 | db      |
      | conn_0 | False   | explain select * from aly_order where id=(select 1) | schema1 |
    Then check resultset "rs_7" has lines with following column values
      | SHARDING_NODE-0    | TYPE-1                | SQL/REF-2                                                                                                                  |
      #| dn2_0              | BASE SQL              | select 1 as `autoalias_scalar`                                                                                             |
      #| merge_1            | MERGE                 | dn2_0                                                                                                                      |
      | scalar_sub_query_1 | SCALAR_SUB_QUERY      | merge_1                                                                                                                    |
      #| dn1_0              | BASE SQL(May No Need) | scalar_sub_query_1; select `aly_order`.`id`,`aly_order`.`c` from  `aly_order` where `aly_order`.`id` = '{NEED_TO_REPLACE}' |
      #| dn2_1              | BASE SQL(May No Need) | scalar_sub_query_1; select `aly_order`.`id`,`aly_order`.`c` from  `aly_order` where `aly_order`.`id` = '{NEED_TO_REPLACE}' |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_8"
      | conn   | toClose | sql                                                                                       | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b on a.id = b.id where a.id =1 and b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_9"
      | conn   | toClose | sql                                                                                       | db      |
      | conn_0 | False   | explain select * from aly_test a join a_manager b on a.id = b.id where a.id =1 and b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_10"
      | conn   | toClose | sql                                                                                   | db      |
      | conn_0 | False   | explain select * from aly_test a join a_three b on a.c = b.c where a.id =4 and b.id=2 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_11"
      | conn   | toClose | sql                                                                                    | db      |
      | conn_0 | False   | explain select * from aly_test a join a_three b on a.c = b.c where a.id =4 and b.id=10 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_12"
      | conn   | toClose | sql                                                                                               | db      |
      | conn_0 | False   | explain select * from aly_test a join a_three b on a.c = b.c where a.id =4 and b.id=2 and b.c='a' | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_13"
      | conn   | toClose | sql                                                                                                      | db      |
      | conn_0 | False   | explain select * from aly_test a,  test_global where a.c=test_global.cc and a.id =3 and test_global.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_14"
      | conn   | toClose | sql                                                                                         | db      |
      | conn_0 | False   | explain select * from aly_test a join schema2.tb_test b on a.c=b.c where a.id =1 and b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_15"
      | conn   | toClose | sql                                                                                         | db      |
      | conn_0 | False   | explain select * from aly_test a join schema2.tb_test b on a.c=b.c where a.id =1 and b.id=2 | schema1 |
    Then check resultset "rs_15" has lines with following column values
      ...
      | join_1          | JOIN          | shuffle_field_1; shuffle_field_3                                                     |
      | shuffle_field_2 | SHUFFLE_FIELD | join_1                                                                               |
# can execute in dble,but cannot execute in this feature because (1064, 'Inner command not route to MySQL')
#    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_16"
#      | conn   | toClose | sql                                                                                                                    | db      |
#      | conn_0 | False   | explain explain select * from aly_test a join a_three b on a.c = b.c where (a.id =4 and b.id=1) or (a.id=4 and b.id=2) | schema1 |
...
#      | dn1             | BASE SQL | select * from aly_test a join a_three b on a.c = b.c where (a.id =4 and b.id=1) or (a.id=4 and b.id=2) |
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_17"
      | conn   | toClose | sql                                                                                                               | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b on a.c = b.c where (a.id =1 and b.id=1) or (a.id=2 and b.id=2)  | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_18"
      | conn   | toClose | sql                                                                                                 | db      |
      | conn_0 | False   | explain select * from aly_test a join a_three b on a.c = b.c where (a.id =4 and b.id=1) or (a.id=3) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_19"
      | conn   | toClose | sql                                                                            | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b on a.id = b.id where a.id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_20"
      | conn   | toClose | sql                                                                                   | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b using(id,c)  where a.id=2 or b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_21"
      | conn   | toClose | sql                                                                                   | db      |
      | conn_0 | False   | explain select * from aly_test a join a_manager b using(id,c)  where a.id=2 or b.id=1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_22"
      | conn   | toClose | sql                                                                             | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b where a.id = b.id and a.id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_23"
      | conn   | toClose | sql                                                                        | db      |
      | conn_0 | False   | explain select * from aly_test a join aly_order b using(id)  where a.id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_25"
      | conn   | toClose | sql                                                                                                                                                   | db      |
      | conn_0 | False   | explain select * from sharding_two_node a join sharding_two_node2 b where a.id =b.id and (( a.id =1 and b.id=1) or ( a.c_flag=b.c_flag and a.id =2 )) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_26"
      | conn   | toClose | sql                                                                                                                                                                     | db      |
      | conn_0 | False   | explain select * from sharding_two_node a join sharding_two_node2 b where a.id =b.id and a.c_decimal=1 and (( a.id =1 and b.id=1) or ( a.c_flag=b.c_flag and a.id =2 )) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_28"
      | conn   | toClose | sql                                                                                                                   | db      |
      | conn_0 | False   | explain select * from sharding_two_node where id =1 and c_flag = (select c_flag from sharding_two_node2 where id =1 ) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_29"
      | conn   | toClose | sql                                                                                                                     | db      |
      | conn_0 | False   | explain select * from sharding_two_node where id =1 and c_flag = (select c_flag from sharding_two_node2 where id =512 ) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_30"
      | conn   | toClose | sql                                                                                                    | db      |
      | conn_0 | False   | explain select * from sharding_two_node where id =1 union select * from sharding_two_node2 where id =1 | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_31"
      | conn   | toClose | sql                                                                                                            | db      |
      | conn_0 | False   | explain select * from aly_order join test_global_1 where aly_order.id in ( select id from aly_test where id=1) | schema1 |
    ...
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_32"
      | conn   | toClose | sql                                                                                                            | db      |
      | conn_0 | False   | explain select * from aly_test a,  test_global_1 where a.c=test_global_1.cc and a.id =3 and test_global_1.id=1 | schema1 |
