...
Feature: check useJoinStrategy
  ...
  """
    ...
    Then execute sql in "dble-1" in "user" mode
     ...
     #ab, ac: singleTable, globalTable same node & left join & left join & no ER & no where => table c nestLoop
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, ac: singleTable, globalTable diff node & left join & left join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | shuffle_field_1   | SHUFFLE_FIELD         | merge_1                                                                                                                                                                                     |
      | dn1_0             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC       |
      | merge_2           | MERGE                 | dn1_0                                                                                                                                                                                       |
    ...
    #ab, ac: singleTable, globalTable same node & left join & left join & no ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: singleTable, globalTable same node & left join & left join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, ac: singleTable, globalTable diff node & left join & left join & no ER & where a & on and b => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then check resultset "rs_2" has lines with following column values
      ...
      | shuffle_field_5 | SHUFFLE_FIELD         | merge_3                                                                                                                                                                               |
      | join_2          | JOIN                  | shuffle_field_2; shuffle_field_5                                                                                                                                                      |
    ...
    # ab, ac: singleTable, globalTable diff node & left join & left join & no ER & where a or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
  ...
  """
    ...
    Then execute sql in "dble-1" in "user" mode
     ...
     #ab, bc: shardingTable, globalTable same node & inner join & inner join & no ER & no where => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, bc: shardingTable, globalTable diff node & inner join & inner join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | shuffle_field_1   | SHUFFLE_FIELD         | merge_1                                                                                                                                                                                 |
      | dn1_0             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC   |
      | dn2_0             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `b`.`deptname`,`b`.`deptid`,`b`.`manager` from  `Dept` `b` where `b`.`manager` in ('{NEED_TO_REPLACE}') ORDER BY `b`.`manager` ASC   |
      | merge_and_order_1 | MERGE_AND_ORDER       | dn1_0; dn2_0                                                                                                                                                                            |
      | shuffle_field_4   | SHUFFLE_FIELD         | merge_and_order_1                                                                                                                                                                       |
      | join_1            | JOIN                  | shuffle_field_1; shuffle_field_4                                                                                                                                                        |
      | order_1           | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_2   | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn1_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_4's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_4's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | merge_and_order_2 | MERGE_AND_ORDER       | dn1_1; dn2_1                                                                                                                                                                            |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, bc: shardingTable, globalTable same node & inner join & inner join & no ER & where a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, bc: shardingTable, globalTable same node & inner join & inner join & no ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, bc: shardingTable, globalTable same node & inner join & inner join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: shardingTable, globalTable diff node & inner join & inner join & no ER & where b & on and a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1           | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_1   | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn1_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_3's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_3's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | merge_and_order_2 | MERGE_AND_ORDER       | dn1_1; dn2_1                                                                                                                                                                            |
    ...
    Then check resultset "rs_2" has lines with following column values
      ...
      | merge_and_order_1 | MERGE_AND_ORDER       | dn1_0; dn2_0                                                                                                                                                                                  |
      | shuffle_field_1   | SHUFFLE_FIELD         | merge_and_order_1                                                                                                                                                                             |
      | dn3_0//dn4_0      | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee_2` `a` where `a`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `a`.`name` ASC |
      | merge_1           | MERGE                 | dn3_0//dn4_0                                                                                                                                                                                  |
    ...
    # ab, bc: shardingTable, globalTable diff node & inner join & inner join & no ER & where a & on or a => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: shardingTable, globalTable diff node & inner join & inner join & no ER & where a or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, bc: shardingTable, globalTable diff node & inner join & inner join & no ER & where a or b or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
  ...
  """
    ...
    Then execute sql in "dble-1" in "user" mode
     ...
     #ab, ac: singleTable, shardingTable same node & left join & inner join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1           | ORDER                 | join_1                                                                                                                                                                                      |
      | shuffle_field_2   | SHUFFLE_FIELD         | order_1                                                                                                                                                                                     |
      | dn1_2             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `c`.`levelname`,`c`.`levelid`,`c`.`salary` from  `Level` `c` where `c`.`levelname` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`levelname` ASC |
      | dn2_1             | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `c`.`levelname`,`c`.`levelid`,`c`.`salary` from  `Level` `c` where `c`.`levelname` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`levelname` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, ac: singleTable, shardingTable diff node & left join & inner join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: singleTable, shardingTable same node & left join & inner join & no ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: singleTable, shardingTable same node & left join & inner join & no ER & where b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: singleTable, shardingTable same node & left join & inner join & no ER & where c => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    #ab, ac: singleTable, shardingTable same node & left join & inner join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, ac: singleTable, shardingTable diff node & left join & inner join & no ER & where a & on and b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    # ab, ac: singleTable, shardingTable diff node & left join & inner join & no ER & where a or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_2 a LEFT JOIN Dept b on a.name=b.manager left join Level c on a.level=c.levelname where a.empid=3401 or c.salary=15000 order by a.name | schema1 |
    # ab, ac: singleTable, shardingTable diff node & left join & inner join & no ER & where a or b or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
  ...
  """
    ...
    Then execute sql in "dble-1" in "user" mode
     ...
     #ab, bc: singleTable, globalTable same node & inner join & inner join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn1_1//dn2_1    | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_4's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name order by a.name | schema1 |
     #ab, bc: singleTable, globalTable diff node & inner join & inner join & no ER & no where => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn1_1//dn2_0    | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_4's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
     ...
     #ab, bc: singleTable, globalTable same node & inner join & inner join & no ER & where a => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=2202 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=2202 order by a.name | schema1 |
     #ab, bc: singleTable, globalTable same node & inner join & inner join & no ER & where b => table a,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where b.deptid=3 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      ...
      | merge_1         | MERGE                 | dn1_0                                                                                                                                                                                         |
      | shuffle_field_1 | SHUFFLE_FIELD         | merge_1                                                                                                                                                                                       |
      | dn2_0           | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee_1` `a` where `a`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `a`.`name` ASC |
      | merge_2         | MERGE                 | dn2_0                                                                                                                                                                                         |
      | shuffle_field_4 | SHUFFLE_FIELD         | merge_2                                                                                                                                                                                       |
      | join_1          | JOIN                  | shuffle_field_1; shuffle_field_4                                                                                                                                                              |
      | order_1         | ORDER                 | join_1                                                                                                                                                                                        |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                       |
      | dn1_1//dn2_1    | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC       |
      | merge_3         | MERGE                 | dn1_1//dn2_1                                                                                                                                                                                  |
      | join_2          | JOIN                  | shuffle_field_2; merge_3                                                                                                                                                                      |
      | order_2         | ORDER                 | join_2                                                                                                                                                                                        |
      | shuffle_field_3 | SHUFFLE_FIELD         | order_2                                                                                                                                                                                       |
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where b.deptid=3 order by a.name | schema1 |
     #ab, bc: singleTable, globalTable same node & inner join & inner join & no ER & where c => table b nestLoop
      Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
        | conn   | toClose | sql                                                         | db |
        | conn_0 | false   | explain SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where c.age=35 order by a.name | schema1|
      Then check resultset "rs_1" has lines with following column values
      ...
      Then execute sql in "dble-1" and the result should be consistent with mysql
        | conn    | toClose  | sql | db  |
        | conn_0  | true     | SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where c.age=35 order by a.name | schema1 |
    # ab, bc: singleTable, globalTable same node & inner join & inner join & no ER & where a,b => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_1 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=2202 and b.deptid=3 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_1 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn1_1//dn2_1    | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_3's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | merge_3         | MERGE                 | dn1_1//dn2_1                                                                                                                                                                            |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_1                                                                                                                                                                               |
      | dn2_0//dn1_1    | BASE SQL              | select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`age` > 20 order by `c`.`name` ASC                                                                |
      | merge_3         | MERGE                 | dn2_0//dn1_1                                                                                                                                                                          |
      | join_2          | JOIN                  | shuffle_field_2; merge_3                                                                                                                                                              |
      | order_2         | ORDER                 | join_2                                                                                                                                                                                |
      | shuffle_field_3 | SHUFFLE_FIELD         | order_2                                                                                                                                                                               |
    Then execute sql in "dble-1" and the result should be consistent with mysql
    ...
    Then check resultset "rs_2" has lines with following column values
      ...
      | join_1          | JOIN                  | shuffle_field_1; shuffle_field_4                                                                                                                                                      |
      | shuffle_field_2 | SHUFFLE_FIELD         | join_1                                                                                                                                                                                |
      | dn2_0//dn1_1    | BASE SQL              | select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c`                                                                                                             |
      | merge_3         | MERGE                 | dn2_0//dn1_1                                                                                                                                                                          |
      | join_2          | JOIN                  | shuffle_field_2; merge_3                                                                                                                                                              |
      | where_filter_1  | WHERE_FILTER          | join_2                                                                                                                                                                                |
      | shuffle_field_3 | SHUFFLE_FIELD         | where_filter_1                                                                                                                                                                        |
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or c.age>20 where a.empid=2202 order by a.name | schema1 |
    # ab, bc: singleTable, globalTable diff node & inner join & inner join & no ER & where b & on and a => table c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and a.empid>1000 where b.deptid=3 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                  |
      | shuffle_field_1 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                 |
      | dn2_0//dn1_1    | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_3's RESULTS; select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `c`.`name` ASC |
      | merge_3         | MERGE                 | dn2_0//dn1_1                                                                                                                                                                            |
      | join_2          | JOIN                  | shuffle_field_1; merge_3                                                                                                                                                                |
      | order_2         | ORDER                 | join_2                                                                                                                                                                                  |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_2                                                                                                                                                                                 |
    ...
    Then check resultset "rs_2" has lines with following column values
      ...
      | merge_1         | MERGE                 | dn1_0                                                                                                                                                                                         |
      | shuffle_field_1 | SHUFFLE_FIELD         | merge_1                                                                                                                                                                                       |
      | dn3_0           | BASE SQL(May No Need) | HINT_NEST_LOOP - shuffle_field_1's RESULTS; select `a`.`name`,`a`.`empid`,`a`.`deptname`,`a`.`level` from  `Employee_2` `a` where `a`.`name` in ('{NEED_TO_REPLACE}') ORDER BY `a`.`name` ASC |
      | merge_2         | MERGE                 | dn3_0                                                                                                                                                                                         |
      | shuffle_field_4 | SHUFFLE_FIELD         | merge_2                                                                                                                                                                                       |
      | join_1          | JOIN                  | shuffle_field_1; shuffle_field_4                                                                                                                                                              |
      | shuffle_field_2 | SHUFFLE_FIELD         | join_1                                                                                                                                                                                        |
    ...
    Then check resultset "rs_1" has lines with following column values
      ...
      | order_1         | ORDER                 | join_1                                                                                                                                                                                        |
      | shuffle_field_2 | SHUFFLE_FIELD         | order_1                                                                                                                                                                                       |
      | dn2_0//dn1_1    | BASE SQL              | select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`age` = 35 order by `c`.`name` ASC                                                                        |
      | merge_3         | MERGE                 | dn2_0//dn1_1                                                                                                                                                                                  |
      | join_2          | JOIN                  | shuffle_field_2; merge_3                                                                                                                                                                      |
      | order_2         | ORDER                 | join_2                                                                                                                                                                                        |
      | shuffle_field_3 | SHUFFLE_FIELD         | order_2                                                                                                                                                                                       |
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name and b.deptid>1 where c.age=35 order by a.name | schema1 |
    # ab, bc: singleTable, globalTable diff node & inner join & inner join & no ER & where c & on or b => table b nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_2"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or b.deptid>1 where c.age=35 order by a.name | schema1|
    Then check resultset "rs_2" has lines with following column values
      ...
      | join_1          | JOIN                  | shuffle_field_1; shuffle_field_4                                                                                                                                                      |
      | shuffle_field_2 | SHUFFLE_FIELD         | join_1                                                                                                                                                                                |
      | dn2_0//dn1_1    | BASE SQL              | select `c`.`name`,`c`.`age`,`c`.`country`,`c`.`deptname` from  `Info` `c` where `c`.`age` = 35                                                                                        |
      | merge_3         | MERGE                 | dn2_0//dn1_1                                                                                                                                                                          |
      | join_2          | JOIN                  | shuffle_field_2; merge_3                                                                                                                                                              |
      | where_filter_1  | WHERE_FILTER          | join_2                                                                                                                                                                                |
      | shuffle_field_3 | SHUFFLE_FIELD         | where_filter_1                                                                                                                                                                        |
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name or b.deptid>1 where a.empid>2000 and c.age=35 order by a.name | schema1 |
    # ab, bc: singleTable, globalTable diff node & inner join & inner join & no ER & where a or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=3401 or c.age=35 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
    ...
    Then execute sql in "dble-1" and the result should be consistent with mysql
      | conn    | toClose  | sql | db  |
      | conn_0  | true     | SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=3401 or c.age=35 order by a.name | schema1 |
    # ab, bc: singleTable, globalTable diff node & inner join & inner join & no ER & where a or b or c => table b,c nestLoop
    Given execute single sql in "dble-1" in "user" mode and save resultset in "rs_1"
      | conn   | toClose | sql                                                         | db |
      | conn_0 | false   | explain SELECT * FROM Employee_2 a INNER JOIN Dept b on a.name=b.manager INNER JOIN Info c on b.manager=c.name where a.empid=3401 or b.deptid=3 or c.age>20 order by a.name | schema1|
    Then check resultset "rs_1" has lines with following column values
