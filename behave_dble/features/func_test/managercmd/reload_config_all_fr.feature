...
Feature: reload @@config_all -fr
  ...
  Scenario: open transaction, execute "reload @@config_all -fr" or "reload @@config_all -f -r" causing transaction closed
    ...
    <dbGroup name="ha_group1" rwSplitMode="0" delayThreshold="100">
        ...
        <dbInstance name="hostS1" url="172.100.9.2:3307" user="test" password="errpwd" maxCon="1000" minCon="10" readWeight="2">
        </dbInstance>
    </dbGroup>
    ...
    <dbGroup name="ha_group1" rwSplitMode="0" delayThreshold="100">
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM1" url="172.100.9.5:3307" user="test" password="111111" maxCon="1000" minCon="10" primary="true" readWeight="1" id="xx1">
        </dbInstance>
        <dbInstance name="hostS1" url="172.100.9.2:3307" user="test" password="111111" maxCon="1000" minCon="10" readWeight="2" disabled="true">
        </dbInstance>
    </dbGroup>
    """
    Then execute admin cmd "reload @@config_all -fr"
