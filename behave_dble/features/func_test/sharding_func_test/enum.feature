...
Feature: Enum sharding function test suits
  ...
  Scenario: Enum sharding function #1
    ...
    Then execute sql in "dble-1" in "user" mode
        ...
        | test | 111111 | conn_0 | False    | insert into enum_table values (0)     | dest_node:mysql-master1 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values (1)     | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values (2)     | dest_node:mysql-master1 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values (3)     | dest_node:mysql-master2 | schema1 |
    ...
    Then execute sql in "dble-1" in "user" mode
        ...
        | test | 111111 | conn_0 | False    | insert into enum_table values(null)      | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values(0)         | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values(1)         | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values(2)         | dest_node:mysql-master1 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values(3)         | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values('aaa')     | dest_node:mysql-master1 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values('bbb')     | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values('ccc')     | dest_node:mysql-master1 | schema1 |
        | test | 111111 | conn_0 | False    | insert into enum_table values('ddd')     | dest_node:mysql-master2 | schema1 |
        | test | 111111 | conn_0 | True     | insert into enum_table values('eee')     | dest_node:mysql-master2 | schema1 |
