...
Feature: check mysqldump import and export
  ...
  Scenario: check mysqldump import and export #1
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | False   | drop table if exists global                                      | schema1 | success |
      | conn_0 | False   | create table global(id int, k varchar(20))                       | schema1 | success |
      | conn_0 | False   | insert into global value (1, repeat('a', 11))                    | schema1 | success |
      | conn_0 | False   | insert into global value (2, repeat('b', 15))                    | schema1 | success |
      | conn_0 | False   | insert into global value (3, repeat('c', 20))                    | schema1 | success |
      | conn_0 | False   | insert into global value (4, repeat('d', 10))                    | schema1 | success |
      ...
      | conn_0 | False   | drop table if exists sharding_4                                  | schema1 | success |
      | conn_0 | False   | create table sharding_4(id int)                                  | schema1 | success |
      | conn_0 | False   | insert into sharding_4 values (1),(2),(3),(4),(5),(6),(7),(8)    | schema1 | success |
      ...
      | conn_0 | False   | drop table if exists sharding_2                                  | schema2 | success |
      | conn_0 | False   | create table sharding_2(id int,node varchar(10))                 | schema2 | success |
      | conn_0 | True    | insert into sharding_2 values(1,'abc'),(2,'12'),(3,'dd'),(4,'3') | schema2 | success |
    ...
    Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                              | db      | expect                                                                                         |
      | conn_0 | False   | select * from global             | schema1 | has{((1,'aaaaaaaaaaa'), (2,'bbbbbbbbbbbbbbb'), (3,'cccccccccccccccccccc'), (4,'dddddddddd'),)} |
      | conn_0 | False   | select * from sing               | schema1 | has{((1,'11111',18),(2,'22222',20),)}                                                          |
      | conn_0 | False   | select * from sharding_4         | schema1 | has{((1,),(2,),(3,),(4,),(5,),(6,),(7,),(8,))}                                                 |
      | conn_0 | False   | select * from no_sharding        | schema1 | has{((1,1),(2,2),(3,2),(4,2),(5,1),)}                                                          |
      | conn_0 | False   | select * from sharding_2         | schema2 | has{((1,'abc'),(2,'12'),(3,'dd'),(4,'3'),)}                                                    |
      | conn_0 | False   | drop table if exists global      | schema1 | success                                                                                        |
      | conn_0 | False   | drop table if exists sing        | schema1 | success                                                                                        |
      | conn_0 | False   | drop table if exists sharding_4  | schema1 | success                                                                                        |
      | conn_0 | False   | drop table if exists no_sharding | schema1 | success                                                                                        |
    ...
    Then execute sql in "dble-1" in "user" mode
      | conn   | toClose  | sql                               | db      | expect      |
      | conn_0 | False    | select * from global              | schema1 | length{(4)} |
      | conn_0 | False    | select * from sing                | schema1 | length{(2)} |
      | conn_0 | False    | select * from sharding_4          | schema1 | length{(8)} |
      | conn_0 | False    | select * from no_sharding         | schema1 | length{(5)} |
      | conn_0 | False    | select * from sharding_2          | schema2 | length{(4)} |
      | conn_0 | False    | drop table if exists global       | schema1 | success     |
      | conn_0 | False    | drop table if exists sing         | schema1 | success     |
      | conn_0 | False    | drop table if exists sharding_4   | schema1 | success     |
      | conn_0 | False    | drop table if exists no_sharding  | schema1 | success     |
      | conn_0 | True     | drop table if exists sharding_2   | schema2 | success     |
