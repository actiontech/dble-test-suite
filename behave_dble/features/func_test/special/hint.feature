...
Feature: verify hint sql
  ...
  Scenario: test hint format: /*!dble:dataNode=xxx*/ #1
    ...
    Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                                                                  | expect                                   | db      |
      | conn_0 | False   | /*!dble:dataNod=dn1*/ drop table if exists test_table                                                | Not supported hint sql type : datanod    | schema1 |
      | conn_0 | False   | /*#dble:dataNode=dn1*/ drop table if exists test_table                                               | success                                  | schema1 |
  ...
  Scenario: hint for specail sql syntax: call procedure #6
    ...
    Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                                 | expect             | db      |
      | conn_0 | False   | /*!dble:dataNode=dn1*/call select_name                          | hasStr{'test_sp2'} | schema1 |
