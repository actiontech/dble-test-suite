  ...
  Scenario: dbGroup rwSplitMode="2", do balance bewteen read dbInstance and write dbInstance #3
    ...
    """
      <dbGroup rwSplitMode="2" name="ha_group2" delayThreshold="100" >
          ...
          <dbInstance name="hostM2" password="111111" url="172.100.9.6:3307" user="test" maxCon="150" minCon="10"/>
      </dbGroup>
    """
    Then execute admin cmd "reload @@config_all"
    Then execute sql in "mysql-master2"
  ...
  Scenario: dbGroup rwSplitMode="2", do balance bewteen read dbInstance and write dbInstance according to their readWeight #4
    ...
    """
      <dbGroup rwSplitMode="2" name="ha_group2" delayThreshold="100" >
          ...
          <dbInstance name="hostM3" password="111111" url="172.100.9.6:3308" user="test" maxCon="150" minCon="10" readWeight="2"/>
      </dbGroup>
    """
  ...
  Scenario: dbGroup rwSplitMode="2", 1m readWeight=0, the write node only accepts write traffic and does not receive read traffic   #9
    ...
    """
      <dbGroup rwSplitMode="2" name="ha_group2" delayThreshold="100" >
          ...
          <dbInstance name="hostM2" password="111111" url="172.100.9.6:3307" user="test" maxCon="150" minCon="10" readWeight="1"/>
          <dbInstance name="hostM3" password="111111" url="172.100.9.6:3308" user="test" maxCon="150" minCon="10" readWeight="1"/>
      </dbGroup>
    """
    Given Restart dble in "dble-1" success
    Then execute sql in "dble-1" in "user" mode
