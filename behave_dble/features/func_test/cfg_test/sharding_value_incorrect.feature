...
Feature: config sharding config files incorrect and restart dble or reload configs
  ...
  Scenario: config sharding property, reload the configs #5
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | False   | create table TB_Single(id int)                    | already exists           | schema1 |
      ...
      | conn_0 | False   | insert into tb_single(id) value(1)                | doesn't exist            | schema1 |
      ...
      | conn_0 | False   | select Tb_Single.id from tb_single                | doesn't exist            | schema1 |
      | conn_0 | False   | select schema1.tb_single.id from schema1.Tb_Single| Unknown column           | schema1 |
      | conn_0 | False   | select schema1.Tb_Single.id from schema1.tb_single| doesn't exist            | schema1 |
