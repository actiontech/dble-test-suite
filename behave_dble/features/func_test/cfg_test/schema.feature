...
Feature: schema basic config test
  ...
  Scenario: config readhost xml node closed with none abbr mode, expect reload success, but fail at present #5
    ...
    """
    <readHost host="hostM1" password="111111" url="172.100.9.6:3307" user="test">
    </readHost>
    """
  ...
  Scenario: Multiple datanodes use the same database of the same datahost #10
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | dryrun              | dataNode dn5 use the same dataHost&database with other dataNode |
      | conn_0 | True    | reload @@config_all | dataNode dn5 use the same dataHost&database with other dataNode |
    ...
    Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                 | expect                                                           |
      | conn_0 | False   | dryrun              | dataNode dn-5 use the same dataHost&database with other dataNode |
      | conn_0 | True    | reload @@config_all | dataNode dn-5 use the same dataHost&database with other dataNode |
    Then restart dble in "dble-1" failed for
    """
    ...
    Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                 | expect                                                           |
      | conn_0 | False   | dryrun              | dataNode dn_5 use the same dataHost&database with other dataNode |
      | conn_0 | True    | reload @@config_all | dataNode dn_5 use the same dataHost&database with other dataNode |
    Then restart dble in "dble-1" failed for
    """
    ...
    Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                 | expect                                                          |
      | conn_0 | False   | dryrun              | dataNode dn4 use the same dataHost&database with other dataNode |
      | conn_0 | True    | reload @@config_all | dataNode dn4 use the same dataHost&database with other dataNode |
    Then restart dble in "dble-1" failed for
    """
  ...
  Scenario: Special characters:'-' in the name of schema and special characters:'.' in the name of database #11
    ...
    Then execute sql in "dble-1" in "admin" mode
      | sql                                 | expect  |
      | create database @@dataNode='dn$1-5' | success |
    Then execute sql in "dble-1" in "user" mode
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | True    | show @@datanodes where schema='schema-1' and table='test-1'      |
