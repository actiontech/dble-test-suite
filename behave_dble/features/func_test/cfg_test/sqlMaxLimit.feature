...
Feature: test sqlMaxLimit for all types of table
  ...
  Scenario: test the sqlMaxLimit of table is prior to the sqlMaxLimit of schema #1
    ...
    <schema dataNode="dn5" name="schema1" sqlMaxLimit="-1">
        <table name="sharding_1_t1" dataNode="dn5"/>
        <table name="sharding_2_t1" dataNode="dn1,dn2" rule="hash-two"/>
        <table name="sharding_4_t1" dataNode="dn1,dn2,dn3,dn4" rule="hash-four">
           <childTable name="tb_child1" joinKey="id" parentKey="id">
                <childTable name="tb_grandson1" joinKey="id" parentKey="id" />
                <childTable name="tb_grandson2" joinKey="id" parentKey="id"/>
            </childTable>
        </table>
        <table type="global" name="global_4_t1" dataNode="dn1,dn2,dn3,dn4" />
    </schema>
  ...
  Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | False   | select * from sharding_1_t1                                                           | length{(8)}                    | schema1 |
      | conn_0 | False   | select * from sharding_2_t1                                                           | length{(8)}                    | schema1 |
      | conn_0 | False   | select * from sharding_4_t1                                                           | length{(8)}                    | schema1|
      | conn_0 | False   | select * from tb_child1                                                               | length{(6)}                    | schema1 |
      | conn_0 | False   | select * from tb_grandson1                                                            | length{(6)}                    | schema1 |
      | conn_0 | False   | select * from tb_grandson2                                                            | length{(6)}                    | schema1 |
      | conn_0 | False   | select * from tb_grandson2 limit 2                                                    | length{(2)}                    | schema1 |
      | conn_0 | False   | select * from global_4_t1                                                             | length{(8)}                    | schema1 |
      | conn_0 | False   | select * from global_4_t1 limit 3                                                     | length{(3)}                    | schema1 |

      | conn_0 | False   | select * from schema2.sharding_4_t2                                                   | length{(4)}                    | schema1 |
      | conn_0 | False   | select * from schema2.sharding_4_t3                                                   | length{(4)}                    | schema1 |
      | conn_0 | False   | select * from schema2.global_4_t1                                                     | length{(4)}                    | schema1 |
