...
Feature: db.xml support fake host
  ...
  Scenario: fake host doesn't support ipv6 and local ip address #10
    ...
    Then execute admin cmd "reload @@config_all" get the following output
    """
    Reload config failure.The reason is db json to map occurred  parse errors, The detailed results are as follows . java.lang.NumberFormatException: For input string: "0:0:0:0:0:0:1:9066"
    """
    Then restart dble in "dble-1" failed for
    """
