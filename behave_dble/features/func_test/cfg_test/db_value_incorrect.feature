...
Feature: config db config files incorrect and restart dble or reload configs
  ...
  Scenario: config db property, reload the configs #2
    ...
    """
     <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM3" password="111111" url="172.100.9.2:3306" user="test" maxCon="1000" minCon="10" primary="false"/>
     </dbGroup>
    """
    Then execute admin cmd "reload @@config_all" get the following output
    """
  ...
  Scenario: config db property, reload the configs #3
    ...
    """
     <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="h~ost@M3" password="111111" url="172.100.9.2:3306" user="test" maxCon="1000" minCon="10" primary="true"/>
     </dbGroup>
    """
    Then execute admin cmd "reload @@config_all" get the following output
    """
  ...
  Scenario: config db property, reload the configs #6
    ...
    """
      <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" disableHA="false">
        ...
        <dbInstance name="hostM2" password="111111" url="172.100.9.2:3306" user="test" usingDecrypt="false" maxCon="1000" minCon="10" readWeight="0" primary="true" disabled="false">
  ...
  Scenario: dbInstance's url duplicate in one dbGroup, reload the configs #9
    ...
    <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
        ...
        <dbInstance name="hostS2" password="111111" url="172.100.9.2:3306" user="test" maxCon="1000" minCon="10" />
    </dbGroup>
    """
    Then execute admin cmd "reload @@config_all" get the following output
      """
      dbGroup[ha_group2]'s child url [172.100.9.2:3306]  duplicated!
      """
  ...
  Scenario: rwSplitUser with dbInstance database type must be MYSQL #13
    ...
    <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM1" password="111111" url="172.100.9.10:3306" user="test" maxCon="100" minCon="10" primary="true" databaseType="mysql"/>
    </dbGroup>
    """
    ...
    <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM1" password="111111" url="172.100.9.10:3306" user="test" maxCon="100" minCon="10" primary="true" databaseType="clickhouse"/>
    </dbGroup>
    """
    Then execute admin cmd "reload @@config_all" get the following output
      """
