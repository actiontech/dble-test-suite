...
Feature: config db config files incorrect and restart dble or reload configs
  ...
  Scenario: config db property, reload the configs #1
    ...
    """
     <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
        ...
        <dbInstance name="hostM4" password="111111" url="172.100.9.6:3307" user="test" maxCon="1000" minCon="10" primary="true"/>
     </dbGroup>
    """
  ...
  Scenario: dbInstance's  add databasetype  #11
    ...
    <dbGroup rwSplitMode="0" name="ha_group1" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM3" password="111111" url="172.100.9.5:3306" user="test" maxCon="1000" minCon="10" primary="true" databaseType="mysql"/>
    </dbGroup>
    """
    Then execute admin cmd "reload @@config_all"
