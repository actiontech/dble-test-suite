...
Feature: check minCon and maxCon in db.xml DBLE0REQ-1246
  ...
  Scenario: minCon < maxCon and minCon > numOfShardingNodes #1
    ...
    <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
        ...
        <dbInstance name="hostM2" password="111111" url="172.100.9.2:3306" user="test" maxCon="100" minCon="20" primary="true" />
    </dbGroup>
    """
    ...
    <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM2" password="111111" url="172.100.9.2:3306" user="test" maxCon="10" minCon="10" primary="true" />
    </dbGroup>
    """
  ...
  Scenario: minCon > maxCon and minCon > numOfShardingNodes #3
    ...
    <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM2" password="111111" url="172.100.9.2:3306" user="test" maxCon="5" minCon="10" primary="true" />
    </dbGroup>
    """
    Then execute admin cmd "reload @@config_all"
    Then execute sql in "dble-1" in "admin" mode
  ...
  Scenario: minCon > maxCon and minCon < numOfShardingNodes #4
    ...
    <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
        <heartbeat>select user()</heartbeat>
        <dbInstance name="hostM2" password="111111" url="172.100.9.2:3306" user="test" maxCon="1" minCon="2" primary="true" />
    </dbGroup>
    """
