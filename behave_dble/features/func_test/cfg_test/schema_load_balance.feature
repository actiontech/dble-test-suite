    ...
    """
        ...
        <dataHost balance="2" maxCon="150" minCon="10" name="ha_group2" slaveThreshold="100" >
            ...
            <writeHost host="hostM1" password="111111" url="172.100.9.6:3306" user="test" weight="1">
              <readHost host="hostM2" url="172.100.9.6:3307" password="111111" user="test" weight="1"/>
              <readHost host="hostM3" url="172.100.9.6:3308" password="111111" user="test" weight="2"/>
            </writeHost>
        </dataHost>
    """
  ...
  Scenario: dataHost balance="2", 1m weight=1, 1s weight=1, 1s weight=0, and weight=0 indicates that traffic is not accepted   #8
    ...
    """
        ...
        <dataHost balance="2" maxCon="150" minCon="10" name="ha_group2" slaveThreshold="100" >
            ...
            <writeHost host="hostM1" password="111111" url="172.100.9.6:3306" user="test" weight="1">
              <readHost host="hostM2" url="172.100.9.6:3307" password="111111" user="test" weight="1"/>
              <readHost host="hostM3" url="172.100.9.6:3308" password="111111" user="test" weight="0"/>
            </writeHost>
        </dataHost>
    """
    Given Restart dble in "dble-1" success
    ...
    """
        ...
        <dataHost balance="2" maxCon="150" minCon="10" name="ha_group2" slaveThreshold="100" >
            ...
            <writeHost host="hostM1" password="111111" url="172.100.9.6:3306" user="test" weight="0">
              <readHost host="hostM2" url="172.100.9.6:3307" password="111111" user="test" weight="1"/>
              <readHost host="hostM3" url="172.100.9.6:3308" password="111111" user="test" weight="1"/>
            </writeHost>
        </dataHost>
    """
    Given Restart dble in "dble-1" success
