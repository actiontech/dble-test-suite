...
#### wget --no-check-certificate --continue https://transtats.bts.gov/PREZIP/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_{2020..2021}_{11..12}.zip

  Scenario: analysisUser supported select    #14
...
#    Then execute sql in "dble-1" in "user" mode
#      | user  | passwd | conn   | toClose | sql                                       | expect   |
#      | ana1  | 111111 | conn_1 | False   | select * from default.ontime limit 10     | success  |
#      | ana1  | 111111 | conn_1 | False   | select * from ontime limit 10             | success  |
#      | ana1  | 111111 | conn_1 | False   | SELECT sum(ALL number) FROM numbers(10)              | success  |
#      | ana1  | 111111 | conn_1 | False   | SELECT sum(number) FROM numbers(10)                  | success  |
#      | ana1  | 111111 | conn_1 | False   | select count(*) from ontime having count(*) > 1              | success  |
#      | ana1  | 111111 | conn_1 | False   | SELECT Year, Month FROM ontime ARRAY JOIN Month                    | success  |
#      | ana1  | 111111 | conn_1 | False   | SELECT DISTINCT Year FROM ontime ORDER BY Month ASC LIMIT 10       | success  |
#select Month into outfile '/test.txt' from ontime
#
#      | ana1 | 111111 | conn_1 | False   | WITH ['hello'] AS hello SELECT hello, * FROM (WITH ['hello'] AS hello SELECT hello)                                                                                                                                         | success |
#      | ana1 | 111111 | conn_1 | False   | WITH(SELECT sum(bytes) FROM system.parts WHERE active) AS total_disk_usage SELECT (sum(bytes) / total_disk_usage) * 100 AS table_disk_usage, table FROM system.parts GROUP BY table ORDER BY table_disk_usage DESC LIMIT 10 | success |
#      | ana1 | 111111 | conn_1 | False   | WITH sum(bytes) as s SELECT formatReadableSize(s),table FROM system.parts GROUP BY table ORDER BY s                                                                                                                         | success |
#      | ana1 | 111111 | conn_1 | False   | WITH '2019-08-01 15:23:00' as ts_upper_bound SELECT * FROM ontime WHERE FlightDate = toDate(ts_upper_bound)                                                                                                                 | success |
#
# SELECT s FROM arrays_test ASOF LEFT JOIN nested_test ON nest.x AND closest_match_cond;
#
#
##      | ana1  | 111111 | conn_1 | False   |               | success  |
##      | ana1  | 111111 | conn_1 | False   |               | success  |
##      | ana1  | 111111 | conn_1 | False   |               | success  |
##      | ana1  | 111111 | conn_1 | False   |               | success  |
##      | ana1  | 111111 | conn_1 | False   |               | success  |
