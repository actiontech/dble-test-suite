...
#  3.21.02 dble-9010
#  Before the xa transaction is submitted, open the firewall to the dble on the host where a certain fragment is located.
#  When the transaction is submitted, the firewall is turned on and the firewall is turned off.
#  When the waiting is not over, the firewall is turned off, and the transaction is submitted successfully.
