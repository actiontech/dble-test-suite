...
Feature: xa_transaction: kill node before transaction rollback
  ...
  Scenario: begin transaction and insert data , kill one node before transaction rollback #1
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | False   | select * from sharding_4_t1 order by id                                                            | hasStr{((1L, 1L, 'a0301', Decimal('0.00')), (2L, 2L, 'a0601', Decimal('0.00')), (3L, 3L, 'a0301', Decimal('0.00')), (4L, 601L, 'a0601', Decimal('0.00')))} | schema1 |
