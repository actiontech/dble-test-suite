...
Feature:Support MySQL's large package protocol
  ...
  ## create table
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | rw1  | 111111 | conn_1 | true    | drop table if exists test11;create table test11 (id int,c longblob)                            | success | db1     |
  ...
  Scenario: test "insert" sql about large packet    #1
    ...
    Then connect "dble-1" to execute "insert into sharding_4_t1 (id,c) values (0," large data "12*1024*1024" on db "schema1" with user "test"
    ...
    #### case 4，rwSplitUser insert sql length 36 ,加上5-6的大包占位符，所以边界值 是41或42
    Then connect "dble-1" to execute "insert into test11 (id,c) values (0," large data "12*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (1," large data "16*1024*1024-37" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (2," large data "16*1024*1024-38" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (3," large data "16*1024*1024-39" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (4," large data "16*1024*1024-40" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (5," large data "16*1024*1024-41" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (6," large data "16*1024*1024-42" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (1," large data "32*1024*1024-37" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (2," large data "32*1024*1024-38" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (3," large data "32*1024*1024-39" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (4," large data "32*1024*1024-40" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (5," large data "32*1024*1024-41" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (6," large data "32*1024*1024-42" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "insert into test11 (id,c) values (7," large data "40*1024*1024" on db "db1" with user "rw1"

    Then execute sql in "dble-1" in "user" mode
      | user | passwd | conn   | toClose | sql                                                                                                                         | expect  | db      |
      | rw1  | 111111 | conn_1 | true    | drop table if exists testing;create table testing (id int,c longblob);select * from testing;drop table if exists testing    | success | db1     |
  ...
  Scenario: test "update" sql about large packet     #2
    ...
    #### case 4，rwSplitUser update sql length 36 ,加上5-6的大包占位符，所以边界值 是41或42
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "12*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-37" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-38" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-39" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-40" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-41" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "16*1024*1024-42" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-37" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-38" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-39" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-40" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-41" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "32*1024*1024-42" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "update test11 set c = 24 where c = (" large data "40*1024*1024" on db "db1" with user "rw1"
  ...
  Scenario: test "delete" sql about large packet    #3
    ...
    #### case 4，rwSplitUser delete sql length 40 ,加上5-6的大包占位符，所以边界值 是46或45
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "12*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "40*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-43" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-44" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-45" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-46" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-47" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "16*1024*1024-48" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-43" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-44" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-45" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-46" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-47" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "delete from test11 where id = 1 or c = (" large data "32*1024*1024-48" on db "db1" with user "rw1"
  ...
  Scenario: test "select" sql about large packet    #4
    ...
    #### case 4，rwSplitUser delete sql length 39 ,加上5-6的大包占位符，所以边界值 是44或45
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "12*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "16*1024*1024-43" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "16*1024*1024-44" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "16*1024*1024-45" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "16*1024*1024-46" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "32*1024*1024-43" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "32*1024*1024-44" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "32*1024*1024-45" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "32*1024*1024-46" on db "db1" with user "rw1"
    Then connect "dble-1" to execute "select c,id from test11 a where a.c = (" large data "40*1024*1024" on db "db1" with user "rw1"
  ...
  Scenario: test "select" sql -- about response has large packet coz:DBLE0REQ-2096      #5
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | rw1 | 111111 | conn_0 | false   | insert into test11 values (0,repeat("x",16*1024*1024)),(1,repeat("x",16*1024*1024-1)),(2,repeat("x",16*1024*1024-2)),(3,repeat("x",16*1024*1024-3)),(4,repeat("x",16*1024*1024-4)),(5,repeat("x",16*1024*1024-5))               | success | db1 |
    ...
    Then execute sql in "dble-1" in "user" mode
      | user | passwd | conn   | toClose | sql                                                                                                                                                                    | expect       | db  | timeout |
      | rw1 | 111111 | conn_0 | false   | select * from sharding_4_t1 where id in (select a.id from test11 a right join sharding_4_t1 b on a.id = b.id and a.id > 22)                                             | success      | db1 | 6,2     |
...
#    Then connect "dble-1" to execute mulit "set trace = 1;select * from sing where c <> (select c from test where c = (" and ") or id = 1);show trace" large data "16*1024*1024" on db "schema1" with user "test"
    ...
    Then connect "dble-1" to execute mulit "begin;delete from test11 where c = (" and ") or id = 1;select 1" large data "32*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute mulit "select 1; select a.id,b.id from test11 a join test11 b on a.id=b.id and b.c = " and " or a.id = 1; begin" large data "32*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute mulit "start transaction; update test11 SET c =" and " where id !=0; DELETE FROM test11" large data "32*1024*1024" on db "db1" with user "rw1"
    Then connect "dble-1" to execute mulit "drop table if exists test_table;create table test_table (id int,c longblob);insert into test_table values (3," and ");select * from test_table" large data "32*1024*1024" on db "db1" with user "rw1"
  ...
  Scenario: test Prepared sql    #7
    ...
    Then execute large data prepared sql "select id from test11 where id =%s or c =" data "16*1024*1024" with params "(1)" on db "db1" and user "rw1"
    Then execute large data prepared sql "select id from test11 where id =%s or c =" data "32*1024*1024" with params "(2)" on db "db1" and user "rw1"
    Then execute large data prepared sql "select id from test11 where id =%s or c =" data "40*1024*1024" with params "(3)" on db "db1" and user "rw1"
    ...
    Then execute sql in "dble-1" in "user" mode
      | user | passwd | conn   | toClose | sql                                                                                            | expect  | db      |
      | rw1  | 111111 | conn_1 | true    | drop table if exists test11;drop table if exists test_table                                    | success | db1     |
    Then check "NullPointerException|unknown error|exception occurred when the statistics were recorded|Exception processing" not exist in file "/opt/dble/logs/dble.log" in host "dble-1"