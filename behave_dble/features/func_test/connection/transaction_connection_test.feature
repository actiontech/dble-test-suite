...
Feature: Transaction query error due to connection used error
  ...
  Scenario: test with commit will not hang, from https://support.actionsky.com/service_desk/browse/ATK-2600  #1
    ...
    Given add xml segment to node with attribute "{'tag':'root'}" in "db.xml"
      """
         ...
         <dbGroup rwSplitMode="0" name="ha_group2" delayThreshold="100" >
          <heartbeat>select user()</heartbeat>
          <dbInstance name="hostM2" password="111111" url="172.100.9.4:3307" user="test" maxCon="1000" minCon="10" primary="true">
          </dbInstance>
        </dbGroup>
         <dbGroup rwSplitMode="0" name="ha_group3" delayThreshold="100" >
          <heartbeat>select user()</heartbeat>
          <dbInstance name="hostM3" password="111111" url="172.100.9.5:3307" user="test" maxCon="1000" minCon="10" primary="true">
          </dbInstance>
        </dbGroup>
