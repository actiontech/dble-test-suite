...
# dble only has mysql5.7 backend
    ...
    | conn_3 | True    | create table test(id int) | success | schema1 |
...
# dble have mysql5.7 and mysql8.0 backend, mysql8.0 connect user is test1
    ...
    Given execute linux command in "dble-1" and contains exception "java.io.IOException: ha_group2.hostM2 - Connection is not available"
    """
