...
#      | conn_0 | true   | insert into dble_db_group(name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value('dbGroup4','select 1',0,1,1,100,'0B01');|Column count doesn't match value count at row 1 |dble_information|
      ...
      | conn_0 | true    | insert into dble_in.dble_db_group(name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value('dbGroup4','select 1',0,1,1,100,'false');                                     | Access denied for user 'root' to database 'dble_in'                      | dble_information |
