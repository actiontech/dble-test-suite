...
Feature: case about load data batch
  ...
  Scenario: Manger CMD reload @@load_data.num        #2
    ...
    Then check following text exist "Y" in file "/opt/dble/conf/bootstrap.dynamic.cnf" in host "dble-1"
      ...
      | conn_0 | True    | select variable_name,variable_value from dble_information.dble_variables where variable_name in ('enableBatchLoadData','maxRowSizeToFile')      | has{(('maxRowSizeToFile', '50000'), ('enableBatchLoadData', '1'),)}  | dble_information  |
      Then check following text exist "Y" in file "/opt/dble/conf/bootstrap.dynamic.cnf" in host "dble-1"
      """
      enableBatchLoadData=1
      ...
      Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                             | expect                                                        | db                |
      | conn_0 | True    | select variable_name,variable_value from dble_information.dble_variables where variable_name in ('enableBatchLoadData','maxRowSizeToFile')      | has{(('maxRowSizeToFile', '50000'), ('enableBatchLoadData', '0'),)}  | dble_information  |
      ...
      Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                             | expect                                                        | db                |
      | conn_0 | True    | select variable_name,variable_value from dble_information.dble_variables where variable_name in ('enableBatchLoadData','maxRowSizeToFile')      | has{(('maxRowSizeToFile', '60000'), ('enableBatchLoadData', '0'),)}  | dble_information  |
  ...
  Scenario: test with Btrace script to check file slice is right     #3
    ...
    Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                             | expect                                                        | db                |
      | conn_0 | True    | select variable_name,variable_value from dble_information.dble_variables where variable_name in ('enableBatchLoadData','maxRowSizeToFile')      | has{(('maxRowSizeToFile', '2'), ('enableBatchLoadData', '1'),)}  | dble_information  |
