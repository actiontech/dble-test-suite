...
#case in xa query delete, questions add 4 and transactions  add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '16',), ('transactions', '9',))}     |
   Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                      |
 ...
 #case in xa query rollback, questions and transactions add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                 |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '17',), ('transactions', '10',))}    |
  ...
  #case query exit, questions and transactions add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '20',), ('transactions', '14',))}    |
  #case query in different seesion,questions and transactions add 1
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '21',), ('transactions', '15',))}    |
   Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                                                                                                |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                               |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '25',), ('transactions', '19',))} |
  ...
  Scenario: check questions/transactions in transaction - shardingUser #3
   ...
   Then execute sql in "dble-1" in "user" mode
     ...
     | conn_1 | False   | commit                                             |
      Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '6',), ('transactions', '4',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '17',), ('transactions', '7',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '21',), ('transactions', '8',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '27',), ('transactions', '11',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '32',), ('transactions', '12',))} | dble_information |
   # questions + 4, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                |
     | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '36',), ('transactions', '13',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '39',), ('transactions', '14',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                |
     | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '42',), ('transactions', '15',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                |
     ...
     | conn_1 | False   | begin                                              |
     | conn_1 | False   | select * from test                                 |
     | conn_1 | False   | create table sharding_4_t1 (id int)                |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '46',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '49',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '52',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '55',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '58',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '61',), ('transactions', '16',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '64',), ('transactions', '17',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '67',), ('transactions', '18',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '71',), ('transactions', '20',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '74',), ('transactions', '21',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '77',), ('transactions', '22',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '80',), ('transactions', '23',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '82',), ('transactions', '23',))} | dble_information |
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                                                                                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '89',), ('transactions', '25',))} |
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                      |
     ...
     Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '93',), ('transactions', '26',))} |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '15',), ('transactions', '8',))}     |
   # other error, questions + 2, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          | expect                                                           |
     | conn_1 | False   | delete from test                             | Table meta 'schema1.test' is lost,PLEASE reload @@metadata       |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '17',), ('transactions', '10',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '22',), ('transactions', '11',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '28',), ('transactions', '13',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '30',), ('transactions', '13',))} | dble_information |
   # compare with show @@questions
  ...
  Scenario: check questions/transactions error sql and implict commit - shardingUser #5
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '9',), ('transactions', '7',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '10',), ('transactions', '8',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '11',), ('transactions', '8',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '13',), ('transactions', '10',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '14',), ('transactions', '12',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '15',), ('transactions', '13',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '16',), ('transactions', '13',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '17',), ('transactions', '14',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          |
     | conn_1 | False   | set autocommit=1, autocommit=1, autocommit=1 |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '18',), ('transactions', '15',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '19',), ('transactions', '16',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '20',), ('transactions', '17',))} | dble_information |
   # compare with show @@questions
   Given execute single sql in "dble-1" in "admin" mode and save resultset in "dble_status_7"
     | conn   | toClose | sql              | db                |
     | conn_0 | True    | show @@questions | dble_information  |
  ...
  Scenario: check questions/transactions - rwSplitUser #7
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '3',), ('transactions', '5',))}      |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql                                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '7',), ('transactions', '9',))}      |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql                                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '12',), ('transactions', '9',))}     |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql              |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '13',), ('transactions', '10',))}    |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql                                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '18',), ('transactions', '10',))}     |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql      |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                 |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '20',), ('transactions', '11',))}    |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql              |
      | split | 111111 | conn_1 | False   | set autocommit=1 |
   #case "set autocommit=1",questions and transactions add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '21',), ('transactions', '12',))}    |
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                           |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '31',), ('transactions', '22',))} | dble_information |
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '32',), ('transactions', '23',))}    |
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                                                                                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '33',), ('transactions', '24',))} |
   Then execute sql in "dble-1" in "user" mode
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '34',), ('transactions', '25',))} |
   #case compare with show @@questions
   Given execute single sql in "dble-1" in "admin" mode and save resultset in "dble_status_8"
      | conn   | toClose | sql              | db                |
      | conn_0 | True    | show @@questions | dble_information  |
  ...
  Scenario: check questions/transactions in transaction - rwSplitUser #8
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '6',), ('transactions', '6',))} | dble_information |
   # questions + 6, transactions + 4
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | set autocommit=0                                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '12',), ('transactions', '8',))} | dble_information |
   # questions + 5, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | set autocommit=0                                   |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '21',), ('transactions', '10',))} | dble_information |
   # questions + 6, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '27',), ('transactions', '13',))} | dble_information |
   # questions + 5, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '32',), ('transactions', '14',))} | dble_information |
   # questions + 4, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '36',), ('transactions', '15',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '39',), ('transactions', '16',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '42',), ('transactions', '17',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                |
     | split | 111111 | conn_1 | False   | begin                                              |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '45',), ('transactions', '18',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | begin                                                 |
     | split | 111111 | conn_1 | False   | select * from test_2                                  |
     | split | 111111 | conn_1 | False   | alter table sharding_4_t1 add column name0 varchar(10) |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '48',), ('transactions', '19',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '51',), ('transactions', '20',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '54',), ('transactions', '21',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '57',), ('transactions', '22',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '60',), ('transactions', '23',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '63',), ('transactions', '25',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | set autocommit=0                                      |
     | split | 111111 | conn_1 | False   | alter table sharding_4_t1 add column name1 varchar(10) |
     | split | 111111 | conn_1 | False   | set autocommit=1                                      |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '66',), ('transactions', '27',))} | dble_information |
   # questions + 4, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                   |
     | split | 111111 | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '96',), ('transactions', '39',))} | dble_information |
   # multiple sql, questions add 1 and transactions add 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '97',), ('transactions', '40',))} | dble_information |
   # questions add 1 and transactions add 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                         |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '98',), ('transactions', '41',))} |
   # multiple sql, questions add 1 and transactions add 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '99',), ('transactions', '42',))} |
   # multiple sql and error sql, questions add 1 and transactions add 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                                                                                                | expect |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '100',), ('transactions', '43',))} |
   # compare with show @@questions
   ...
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                        | expect                                                 |
     | split | 111111 | conn_1 | False   | set autocommit=2                           | illegal value |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '12',), ('transactions', '5',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '16',), ('transactions', '8',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '18',), ('transactions', '8',))}  | dble_information |
   # set questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                     |
     | split | 111111 | conn_1 | True    | set autocommit=1        |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
   ...
   # 1064 error sql,questions and transactions add 1
     Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                           | expect                                               |
     | split | 111111 | conn_1 | False   | create tables test_1 (id int) | You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'tables test_1 (id int)' at line 1 |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '3',), ('transactions', '3',))} | dble_information |
   # other error, questions + 2, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                 | expect                           |
     | split | 111111 | conn_1 | False   | delete from test_1                  | Table 'db1.test_1' doesn't exist |
     | split | 111111 | conn_1 | False   | create index id_index on test_1(id) | Table 'db1.test_1' doesn't exist |
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '5',), ('transactions', '6',))} | dble_information |
   # 1064 error in transaction, questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql         | expect  |
     | split | 111111 | conn_1 | False   | begin       | success |
     | split | 111111 | conn_1 | False   | set trace=0 | success |
     | split | 111111 | conn_1 | False   | rollback    | success |
     Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '8',), ('transactions', '7',))} | dble_information |
