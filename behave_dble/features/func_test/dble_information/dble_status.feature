...
#case query sql in xa not commit, questions add 2 but transactions donot add ( earlier 3.22.11 )
#case query sql in xa not commit, questions add 2 but transactions  "set autocommit=0"  add 1 ( 3.22.11 )
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '9',), ('transactions', '8',))}      |
   Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                      |
...
#case query sql in xa not commit, questions add 2 but transactions donot add
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '11',), ('transactions', '8',))}     |
   Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                      |
      | conn_1 | False   | commit                                                   |
...
#case in xa query delete, questions add 4 and transactions  donot add
 ...
 #case in xa query rollback, questions and transactions add 1
  ...
  #case quit xa query "set autocommit=1"  ,questions add 2 ,but transactions "set xa=off" add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
  ...
  #case query in different seesion,questions and transactions add 2 (use shcema1 and exit)
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '21',), ('transactions', '14',))}    |
   Then execute sql in "dble-1" in "user" mode
      | conn   | toClose | sql                                                                                                                                |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                               |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '25',), ('transactions', '18',))} |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '46',), ('transactions', '20',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '49',), ('transactions', '21',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '52',), ('transactions', '22',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '55',), ('transactions', '23',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '58',), ('transactions', '24',))} | dble_information |
   # questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | begin                                                 |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '61',), ('transactions', '25',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '64',), ('transactions', '27',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '67',), ('transactions', '29',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '71',), ('transactions', '31',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '74',), ('transactions', '33',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '77',), ('transactions', '35',))} | dble_information |
   # questions + 3, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                                   |
     | conn_1 | False   | set autocommit=0                                      |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '80',), ('transactions', '37',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "user" mode
     ...
     Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                       | expect                                               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '93',), ('transactions', '44',))} |
   ...
   # 1064 error, questions + 2, transactions + 0
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '4',), ('transactions', '2',))}      |
   ...
   # 1064 error in transaction, questions + 3, transactions "begin" + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                       | expect  |
   ...
   # 1064 error, questions + 1, transactions + 0
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '14',), ('transactions', '6',))}     |
   # other error, questions + 2, transactions + 2
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          | expect                                                           |
     | conn_1 | False   | delete from test                             | Table meta 'schema1.test' is lost,PLEASE reload @@metadata       |
   ...
   # other error in transaction, questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                             | expect                              |
     | conn_1 | False   | rollback                        | success                             |
     | conn_1 | False   | begin                           | success                             |
   ...
   # 1064 error in Implicit Commit, questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                       | expect  |
     | conn_1 | False   | rollback                  | success |
     | conn_1 | False   | begin                     | success |
   ...
   # other error in Implicit Commit and table does not config in sharding.xml, questions + 3, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                             | expect                                                           |
     | conn_1 | False   | rollback                        | success                                                          |
     | conn_1 | False   | begin                           | success                                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '27',), ('transactions', '12',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '29',), ('transactions', '13',))} | dble_information |
   # compare with show @@questions
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '7',), ('transactions', '6',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | true    | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '11',), ('transactions', '9',))}  | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '7',), ('transactions', '3',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '8',), ('transactions', '3',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '9',), ('transactions', '4',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '10',), ('transactions', '4',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '11',), ('transactions', '4',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '13',), ('transactions', '5',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '15',), ('transactions', '6',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '16',), ('transactions', '6',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '18',), ('transactions', '7',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '19',), ('transactions', '8',))} | dble_information |
   # set questions + 1, transactions + 0, close connection questions + 0, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '20',), ('transactions', '8',))} | dble_information |
   # compare with show @@questions
   Given execute single sql in "dble-1" in "admin" mode and save resultset in "dble_status_7"
     | conn   | toClose | sql              | db                |
     | conn_0 | True    | show @@questions | dble_information  |
   ...
   Then execute sql in "dble-1" in "user" mode
      ...
      | split | 111111 | conn_1 | False   | select * from test_3                  |
   #case sql in transaction , questions add 5 , transactions add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
   ...
   #case "set autocommit=1" transaction, questions and transactions add 0
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
   ...
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '18',), ('transactions', '9',))}     |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql      |
      | split | 111111 | conn_1 | False   | rollback |
   #case rollback transaction, questions and transactions add 0
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                 |
   ...
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql              |
      | split | 111111 | conn_1 | False   | set autocommit=0 |
   #case query "set autocommit=0",questions add 1 ,transactions add 1
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                 |
      | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%'   | has{(('questions', '20',), ('transactions', '10',))}    |
   Then execute sql in "dble-1" in "user" mode
      | user  | passwd | conn   | toClose | sql              |
      | split | 111111 | conn_1 | False   | set autocommit=1 |
   #case "set autocommit=1",questions and transactions add 0
   Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                       | expect                                                  |
   ...
   #case in xa, questions add 10  and  transactions add 2  "xa start 'xa_test_1'"   "xa start 'xa_test_2' "
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '31',), ('transactions', '12',))} | dble_information |
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                   |
...
# DBLE0REQ-1117
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                             | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '9',), ('transactions', '3',))} | dble_information |
   # 1064 error sql questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                        | expect             |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '10',), ('transactions', '3',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '11',), ('transactions', '3',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '12',), ('transactions', '3',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                        |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                              | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '13',), ('transactions', '4',))} | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '14',), ('transactions', '4',))}  | dble_information |
   # questions + 1, transactions + 0
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '15',), ('transactions', '4',))}  | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '16',), ('transactions', '5',))} | dble_information |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '17',), ('transactions', '5',))} | dble_information |
   # questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                                          |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '18',), ('transactions', '6',))}  | dble_information |
   # set questions + 1, transactions + 1
   Then execute sql in "dble-1" in "user" mode
     | user  | passwd | conn   | toClose | sql                     |
   ...
   Then execute sql in "dble-1" in "admin" mode
     | conn   | toClose | sql                                                                                     | expect                                               | db               |
     | conn_0 | False   | select variable_name,variable_value from dble_status where variable_name like '%tions%' | has{(('questions', '19',), ('transactions', '7',))}  | dble_information |
   # compare with show @@questions
