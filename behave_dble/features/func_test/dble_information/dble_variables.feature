...
Feature:  dble_variables test
 ...
 Scenario:  dble_variables table #1
  ...
  #case select * from dble_variables
    ...
    Then check resultset "dble_variables_2" has lines with following column values and has "145" lines
  ...
  #case supported select limit /order by/ where like
      ...
      | conn_0 | False   | select read_only from dble_variables                              | length{(145)}| dble_information |
