 ...
 Scenario:  dble_variables table #1
  ...
  #case desc dble_variables
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select * from dble_variables    | length{(110)}     | dble_information |
  #case select * from dble_variables
    ...
    Then check resultset "dble_variables_2" has lines with following column values
      ...
      | enableCheckSchema                       | 1                   | Whether enable check schema, default value is 1(on)                                                                                                                                                                  | true      |
  ...
  #case supported select limit /order by/ where like
      ...
      | conn_0 | False   | select read_only from dble_variables                              | length{(110)}| dble_information |
  ...
  #case supported select * from dble_variables where [sub-query]
      ...
      | conn_0 | False   | select * from dble_variables where variable_name < any (select variable_name from dble_status )  | length{(93)}         | dble_information |
