...
Feature:  dble_variables test
  ...
  Scenario:  dble_variables table #1
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select * from dble_variables    | length{(117)}     | dble_information |
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select read_only from dble_variables                              | length{(117)}| dble_information |
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select * from dble_variables where variable_name > any (select variable_name from dble_status )  | length{(97)}         | dble_information |
