 ...
 Scenario:  dble_variables table #1
  ...
  #case desc dble_variables
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select * from dble_variables    | length{(97)}      | dble_information |
   ...
   #case supported select limit /order by/ where like
      ...
      | conn_0 | False   | select read_only from dble_variables                              | length{(97)} | dble_information |
  ...
  #case supported select * from dble_variables where [sub-query]
      Then execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                              | expect               | db               |
      | conn_0 | False   | select * from dble_variables where variable_name < any (select variable_name from dble_status )  | length{(80)}         | dble_information |
