...
Feature:  dble_variables test
  ...
  Scenario:  dble_variables table #1
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | False   | select * from dble_variables    | length{(95)}      | dble_information |
    ...
    Then check resultset "dble_variables_2" has lines with following column values
      ...
      | backendProcessors           | 80                              | The size of backend NIOProcessor, the default value is the number of processors available to the Java virtual machine                                       | true        |
      ...
      | backendProcessorExecutor    | 80                              | The size of fixed thread pool named of backend businessExecutor,the default value is the number of processors available to the Java virtual machine * 2     | true        |
      ...
      | writeToBackendExecutor      | 80                              | The executor for complex query.The default value is min(8, default value of processorExecutor)                                                              | true        |
  ...
  #case supported select limit /order by/ where like
      ...
      | conn_0 | False   | select read_only from dble_variables                              | length{(95)} | dble_information |
