 ...
 Scenario:  dble_variables table #1
  ...
  #case select * from dble_variables
    ...
    Then check resultset "dble_variables_2" has lines with following column values
      ...
      | checkTableConsistencyPeriod | 1800000ms                       | The period of consistency tableStructure check .The default value is 30*60*1000                                                                             | true        |
      ...
      | xaRecoveryLogBaseName       | xalog                           | The name of the xa transaction record file.The default value is tmlog                                                                                       | true        |
