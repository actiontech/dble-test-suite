...
Feature: sql_statistic_by_frontend_by_backend_by_entry_by_user
  ...
  Scenario: simple sql test #1
   ...
   Given add xml segment to node with attribute "{'tag':'root'}" in "db.xml"
    ...
    Then check resultset "resultset_1" has lines with following column values and has "4" lines
    ...
    Then check resultset "resultset_2" has lines with following column values and has "1" lines
    ...
    Then check resultset "resultset_11" has lines with following column values and has "7" lines
      | entry-0 | user-1 | backend_host-3 | backend_port-4 | sharding_node-5 | db_instance-6 | tx_count-7 | tx_rows-8 | sql_insert_count-10 | sql_insert_rows-11 | sql_update_count-13 | sql_update_rows-14 | sql_delete_count-16 | sql_delete_rows-17 | sql_select_count-19 | sql_select_rows-20 |
      | 2       | test   | 172.100.9.6    | 3306           | dn2             | hostM2        | 8          | 5         | 1                   | 1                  | 2                   | 1                  | 1                   | 1                  | 2                   | 2                  |
      | 2       | test   | 172.100.9.5    | 3306           | dn1             | hostM1        | 7          | 5         | 1                   | 1                  | 2                   | 2                  | 1                   | 1                  | 1                   | 1                  |
      | 2       | test   | 172.100.9.6    | 3306           | dn4             | hostM2        | 8          | 4         | 1                   | 1                  | 1                   | 1                  | 2                   | 1                  | 2                   | 1                  |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_12"
      | conn   | toClose | sql                                                                 | db               |
      | conn_0 | True    | select * from sql_statistic_by_frontend_by_backend_by_entry_by_user | dble_information |
    Then check resultset "resultset_12" has lines with following column values and has "9" lines
      | entry-0 | user-1 | backend_host-3 | backend_port-4 | sharding_node-5 | db_instance-6 | tx_count-7 | tx_rows-8 | sql_insert_count-10 | sql_insert_rows-11 | sql_update_count-13 | sql_update_rows-14 | sql_delete_count-16 | sql_delete_rows-17 | sql_select_count-19 | sql_select_rows-20 |
      | 2       | test   | 172.100.9.6    | 3306           | dn2             | hostM2        | 8          | 5         | 1                   | 1                  | 2                   | 1                  | 1                   | 1                  | 2                   | 2                  |
      | 2       | test   | 172.100.9.5    | 3306           | dn1             | hostM1        | 7          | 5         | 1                   | 1                  | 2                   | 2                  | 1                   | 1                  | 1                   | 1                  |
      | 2       | test   | 172.100.9.6    | 3306           | dn4             | hostM2        | 8          | 4         | 1                   | 1                  | 1                   | 1                  | 2                   | 1                  | 2                   | 1                  |
    ...
    Then check resultset "resultset_13" has lines with following column values and has "4" lines
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_14"
      | conn   | toClose | sql                                                                 | db               |
      | conn_0 | False   | select entry,user,backend_host,backend_port,sharding_node,db_instance,tx_count,tx_rows,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_frontend_by_backend_by_entry_by_user | dble_information |
    Then check resultset "resultset_14" has lines with following column values and has "2" lines
      | entry-0 | user-1 | backend_host-2 | backend_port-3 | sharding_node-4 | db_instance-5 | tx_count-6 | tx_rows-7 | sql_insert_count-8 | sql_insert_rows-9 | sql_update_count-10 | sql_update_rows-11 | sql_delete_count-12 | sql_delete_rows-13 | sql_select_count-14 | sql_select_rows-15 |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_24"
      | conn   | toClose | sql                                                                 | db               |
      | conn_0 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_24" has lines with following column values and has "1" lines
      | entry-0 | user-1 | table-2 | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
...
#      | 2       | test   | schema1.sharding_4_t1,schema2.test1         | 1                  | 0                 |
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | True    | select * from sql_statistic_by_frontend_by_backend_by_entry_by_user | dble_information |
    Then check resultset "resultset_12" has lines with following column values and has "3" lines
      | entry-0 | user-1 | backend_host-3 | backend_port-4 | sharding_node-5 | db_instance-6 | tx_count-7 | tx_rows-8 | sql_insert_count-10 | sql_insert_rows-11 | sql_update_count-13 | sql_update_rows-14 | sql_delete_count-16 | sql_delete_rows-17 | sql_select_count-19 | sql_select_rows-20 |
...
#      | conn   | toClose | sql                                                                 | db               |
#      | conn_1 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
#    Then check resultset "resultset_22" has lines with following column values and has "4" lines
#      | entry-0 | user-1 | table-2                | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
...
#      | 3       | test1  | schema1.sharding_2_t1  | 0                  | 0                 | 1                  | 1                 | 1                  | 1                 | 2                  | 4                  |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_32"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,associate_tables,sql_select_count,sql_select_rows from sql_statistic_by_associate_tables_by_entry_by_user  | dble_information |
    Then check resultset "resultset_32" has lines with following column values and has "2" lines
      | entry-0 | user-1 | associate_tables-2                       | sql_select_count-3 | sql_select_rows-4 |
    ...
    Then check resultset "resultset_13" has lines with following column values and has "1" lines
      | entry-0 | user-1 | backend_host-2 | backend_port-3 | sharding_node-4 | db_instance-5 | tx_count-6 | tx_rows-7 | sql_insert_count-8 | sql_insert_rows-9 | sql_update_count-10 | sql_update_rows-11 | sql_delete_count-12 | sql_delete_rows-13 | sql_select_count-14 | sql_select_rows-15 |
...
#      (4, 'split1', 'db1.test_table1', 0, 0, 0, 0, 1, 0, 3, 12)
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn   | toClose | sql                                                                                                                                                                                                                                                                                   | db               |
      | conn_1 | True    | select entry,user,backend_host,backend_port,sharding_node,db_instance,tx_count,tx_rows,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_frontend_by_backend_by_entry_by_user | dble_information |
    Then check resultset "resultset_14" has lines with following column values and has "1" lines
      | entry-0 | user-1 | backend_host-2 | backend_port-3 | sharding_node-4 | db_instance-5 | tx_count-6 | tx_rows-7 | sql_insert_count-8 | sql_insert_rows-9 | sql_update_count-10 | sql_update_rows-11 | sql_delete_count-12 | sql_delete_rows-13 | sql_select_count-14 | sql_select_rows-15 |
      | 2       | test   | 172.100.9.5    | 3306           | dn5             | hostM1        | 2          | 6         | 0                  | 0                 | 0                   | 0                  | 0                   | 0                  | 1                   | 6                  |
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_24"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_24" has lines with following column values and has "2" lines
      | entry-0 | user-1 | table-2                | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_34"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,associate_tables,sql_select_count,sql_select_rows from sql_statistic_by_associate_tables_by_entry_by_user  | dble_information |
    Then check resultset "resultset_34" has lines with following column values and has "1" lines
      | entry-0 | user-1 | associate_tables-2                     | sql_select_count-3 | sql_select_rows-4 |
 ...
 @auto_retry
  Scenario: transaction sql test #4
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_21"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_21" has lines with following column values and has "2" lines
      | entry-0 | user-1 | table-2               | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_31"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | true    | select entry,user,associate_tables,sql_select_count,sql_select_rows from sql_statistic_by_associate_tables_by_entry_by_user  | dble_information |
    Then check resultset "resultset_31" has lines with following column values and has "1" lines
      | entry-0 | user-1 | associate_tables-2                          | sql_select_count-3 | sql_select_rows-4 |
    ...
    Then check resultset "resultset_12" has lines with following column values and has "1" lines
      | entry-0 | user-1 | backend_host-2 | backend_port-3 | sharding_node-4 | db_instance-5 | tx_count-6 | tx_rows-7 | sql_insert_count-8 | sql_insert_rows-9 | sql_update_count-10 | sql_update_rows-11 | sql_delete_count-12 | sql_delete_rows-13 | sql_select_count-14 | sql_select_rows-15 |
      | 1       | rwS1   | 172.100.9.4    | 3306           | -               | hostM1        | 2          | 4         | 1                  | 1                 | 2                   | 1                  | 1                   | 0                  | 1                   | 2                  |
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_22"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_22" has lines with following column values and has "2" lines
      | entry-0 | user-1 | table-2         | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_23"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | true    | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_23" has lines with following column values and has "2" lines
      | entry-0 | user-1 | table-2         | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_32"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | true    | select entry,user,associate_tables,sql_select_count,sql_select_rows from sql_statistic_by_associate_tables_by_entry_by_user  | dble_information |
    Then check resultset "resultset_32" has lines with following column values and has "1" lines
      | entry-0 | user-1 | associate_tables-2              | sql_select_count-3 | sql_select_rows-4 |
  ...
  Scenario: xa transaction sql test #5
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "resultset_21"
      | conn   | toClose | sql                                                                 | db               |
      | conn_1 | False   | select entry,user,table,sql_insert_count,sql_insert_rows,sql_update_count,sql_update_rows,sql_delete_count,sql_delete_rows,sql_select_count,sql_select_rows from sql_statistic_by_table_by_user_by_entry  | dble_information |
    Then check resultset "resultset_21" has lines with following column values and has "1" lines
      | entry-0 | user-1 | table-2               | sql_insert_count-3 | sql_insert_rows-4 | sql_update_count-5 | sql_update_rows-6 | sql_delete_count-7 | sql_delete_rows-8 | sql_select_count-9 | sql_select_rows-10 |
  ...
  Scenario:  error sql test #7
   ...
   #pre env,for truncate
    ...
    Then check resultset "resultset_11" has lines with following column values and has "1" lines
