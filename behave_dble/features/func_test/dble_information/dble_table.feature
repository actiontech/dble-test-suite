...
#@skip_restart
  ...
  #case create new tables
   ...
   #case select limit/order by/where like
      ...
      | conn_0 | False   | select * from dble_table where type like '%sharding%'       | length{(9)}                                                                                  |
  #case select max/min
...
#      | conn_0 | False   | select type from dble_table where schema in (select schema from dble_table where id like '%c%') | has{(('BusinessExecutor', 1, 1, 0), ('backendBusinessExecutor', 8, 0, 0))}     |
  #case update/delete
      ...
      | conn_0 | False   | insert into dble_table values ('a','1',2,'3')                   | update syntax error, not support insert with syntax :[LOW_PRIORITY \| DELAYED \| HIGH_PRIORITY] [IGNORE][ON DUPLICATE KEY UPDATE assignment_list] |
...
#@skip_restart
  ...
  #case select field and where [sub-query]
#      | conn_0 | False   | select id from dble_global_table where check_class in (select check_class from dble_global_table where check = 'true') | has{(('BusinessExecutor', 1, 1, 0), ('backendBusinessExecutor', 8, 0, 0))}     |
  #case update/delete
      ...
      | conn_0 | False   | insert into dble_global_table values ('a','1','2','3')        | update syntax error, not support insert with syntax :[LOW_PRIORITY \| DELAYED \| HIGH_PRIORITY] [IGNORE][ON DUPLICATE KEY UPDATE assignment_list] |
...
#@skip_restart
  ...
  #case select field and where [sub-query]
#      | conn_0 | False   | select id from dble_sharding_table where sharding_column in (select sharding_column from dble_sharding_table where sql_required_sharding = 'true') | has{(('BusinessExecutor', 1, 1, 0), ('backendBusinessExecutor', 8, 0, 0))}     |
  #case update/delete
      ...
      | conn_0 | False   | insert into dble_sharding_table values ('a','1','2','3')        | update syntax error, not support insert with syntax :[LOW_PRIORITY \| DELAYED \| HIGH_PRIORITY] [IGNORE][ON DUPLICATE KEY UPDATE assignment_list] |
...
#      | sharding_node | varchar(32) | NO     | PRI   | None      |         |
  ...
  #case select field and where [sub-query]
#      | conn_0 | False   | select id from dble_table_sharding_node where sharding_node in (select sharding_node from dble_table_sharding_node where order > 2) | has{(('BusinessExecutor', 1, 1, 0), ('backendBusinessExecutor', 8, 0, 0))}     |
  #case update/delete
      ...
      | conn_0 | False   | insert into dble_sharding_table values ('a','1')               | update syntax error, not support insert with syntax :[LOW_PRIORITY \| DELAYED \| HIGH_PRIORITY] [IGNORE][ON DUPLICATE KEY UPDATE assignment_list] |
...
#      | parent_id        | varchar(64) | NO     |       | None      |         |
  ...
  #case select field and where [sub-query]
#      | conn_0 | False   | select id from dble_child_table where sharding_node in (select sharding_node from dble_child_table where order > 2) | has{(('BusinessExecutor', 1, 1, 0), ('backendBusinessExecutor', 8, 0, 0))}     |
  #case update/delete
      ...
      | conn_0 | False   | insert into dble_child_table values ('a','1','a','1')      | update syntax error, not support insert with syntax :[LOW_PRIORITY \| DELAYED \| HIGH_PRIORITY] [IGNORE][ON DUPLICATE KEY UPDATE assignment_list] |
...
@skip_restart
 ...
 select * from dble_table,dble_child_table where dble_table.id ='C4';

 select a.* from dble_table a,dble_child_table b where a.id = 'C4' and b.parent_id = 'C3';
