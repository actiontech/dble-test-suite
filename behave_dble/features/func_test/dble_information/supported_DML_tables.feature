...
# Created by maofei at 2020/9/23 change by quexiuping 2021/5/7
  ...
  Scenario: test the langreage of insert in dble manager   ---- dble_db_group  #1
    ##name / heartbeat_stmt / heartbeat_timeout / heartbeat_retry / rw_split_mode / delay_threshold  / disable_ha / active
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | insert into DBLE_db_group set name='ha_group21',heartbeat_stmt='select user',rw_split_mode=2,disable_ha='true'    | success     | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='ha_group20',heartbeat_stmt='select user',rw_split_mode=2,disable_ha='true'    | success     | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM6',db_group='0B02',addr='172.100.9.4',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9,database_type='clickhouse'      | success        | dble_information |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_group #4
    ...
    Then check resultset "dble_db_group_2" has lines with following column values
      ...
      | ha_group3  | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group4  | select 2          | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group6  | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group7  | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group12 | select 7          | 888                 | 1                 | 1               | 88                | false        | true      |
      | ha_group8  | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group9  | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group10 | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | ha_group11 | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | 0B02       | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | 0B03       | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
      | 0B04       | select @a         | 888                 | 100               | 1               | 88                | false        | true      |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_instance #5
    ...
    Then check resultset "dble_db_instance_1" has lines with following column values
      ...
      | hostM6  | ha_group6  | 172.100.9.4 | 3306   | test   | false                | true      | false      | 4                | 1000             | 3              |
   ...
   ### id 这一列在3.22.01版本中 不会变动的
    ...
    Then check resultset "dble_db_instance_2" has lines with following column values
      | name-0  | db_group-1 | addr-2      | port-3 | user-4 | encrypt_configured-5 | primary-6 | disabled-7 | min_conn_count-8 | max_conn_count-9 | read_weight-10 |
      | hostM1  | ha_group1  | 172.100.9.5 | 3306   | test   | false                | true      | true       | 10               | 100              | 0              |
...
#      | conn_0 | false   | update dble_db_instance set database_type=null where name='0B021'                                | success      | dble_information |
  ...
  Scenario: test the langreage of delete in dble manager   ---- dble_db_group   dble_db_instance  dble_rw_split_entry #7
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | delete from dble_db_group where active ='true'                                 | Delete failure.The reason is Cannot delete or update a parent row: a foreign key constraint fails    | dble_information |
      | conn_0 | false   | delete from dble_db_group where name ='ha_group2'                              | Delete failure.The reason is Cannot delete or update a parent row: a foreign key constraint fails    | dble_information |
