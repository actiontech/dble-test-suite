...
# Created by maofei at 2020/9/23 change by quexiuping 2021/5/7
  ...
  Scenario: test the langreage of insert in dble manager   ---- dble_db_group  #1
    ##name / heartbeat_stmt / heartbeat_timeout / heartbeat_retry / heartbeat_keep_alive / rw_split_mode / delay_threshold  / disable_ha / active
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM6',db_group='0B02',addr='172.100.9.4',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9,database_type='clickhouse'      | success        | dble_information |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_group #4
    ...
    Then check resultset "dble_db_group_1" has lines with following column values
      | name-0     | heartbeat_stmt-1  | heartbeat_timeout-2 | heartbeat_retry-3 | heartbeat_keep_alive-4 | rw_split_mode-5 | delay_threshold-6 | disable_ha-7 | active-8  |
      | ha_group1  | select 55         | 888                 | 1                 | 60                     | 1               | 88                | false        | true      |
      | ha_group2  | select user()     | 888                 | 1                 | 60                     | 1               | 88                | false        | true      |
      | ha_group3  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group4  | select 2          | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group5  | show slave status | 888                 | 100               | 60                     | 2               | 88                | true         | true      |
      | ha_group6  | select @a         | 888                 | 100               | 60                     | 1               | 88                | true         | true      |
      | ha_group7  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group12 | select 7          | 888                 | 1                 | 60                     | 1               | 88                | false        | true      |
      | ha_group8  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group9  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group10 | select @a         | 888                 | 100               | 60                     | 1               | 88                | true         | true      |
      | ha_group11 | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B02       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B03       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B04       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B05       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
    ...
    Then check resultset "dble_db_group_2" has lines with following column values
      ...
      | ha_group3  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group4  | select 2          | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group6  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group7  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group12 | select 7          | 888                 | 1                 | 60                     | 1               | 88                | false        | true      |
      | ha_group8  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group9  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group10 | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group11 | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B02       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B03       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B04       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
...
#      | conn_0 | false   | update dble_db_instance set database_type=null where name='0B021'                                | success      | dble_information |
  ...
  Scenario: test the langreage of delete in dble manager   ---- dble_db_group   dble_db_instance  dble_rw_split_entry #7
    ...
    Then check resultset "dble_db_group_1" has lines with following column values
      ...
      | ha_group7  | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | ha_group12 | select 7          | 888                 | 1                 | 60                     | 1               | 88                | false        | true      |
      | ha_group11 | select @a         | 888                 | 100               | 80                     | 1               | 88                | false        | true      |
      | 0B02       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
      | 0B04       | select @a         | 888                 | 100               | 60                     | 1               | 88                | false        | true      |
