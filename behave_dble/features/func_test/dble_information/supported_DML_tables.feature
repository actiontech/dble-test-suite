...
## DBLE0REQ-1085
  ...
  Scenario: test the langreage of insert in dble manager   ---- dble_db_instance  #2
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | insert into dble_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,disabled,min_conn_count,max_conn_count,read_weight,id,connection_timeout,connection_heartbeat_timeout,test_on_create,test_on_borrow,test_on_return,test_while_idle,time_between_eviction_runs_millis,evictor_shutdown_timeout_millis,idle_timeout,heartbeat_period_millis) value ('hostM3','ha_group3','172.100.9.1',3307,'test','111111','false','true','true',10,1000,1,'hostM3',30000,200,'false','false','false','false',1,1,1,1)                     | success   | dble_information |
      | conn_0 | false   | insert into dble_information.dble_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,disabled,min_conn_count,max_conn_count,read_weight,id,connection_timeout,connection_heartbeat_timeout,test_on_create,test_on_borrow,test_on_return,test_while_idle,time_between_eviction_runs_millis,evictor_shutdown_timeout_millis,idle_timeout,heartbeat_period_millis) value ('hostS31','ha_group3','172.100.9.2',3307,'test','111111','false','false','false',1,10,2,'hostS31',3,1,'true','true','true','true',2,2,2,2)             | success   | dble_information |
      | conn_0 | false   | insert into dble_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,disabled,min_conn_count,max_conn_count,read_weight,id,connection_timeout,connection_heartbeat_timeout,test_on_create,test_on_borrow,test_on_return,test_while_idle,time_between_eviction_runs_millis,evictor_shutdown_timeout_millis,idle_timeout,heartbeat_period_millis) value ('hostS32','ha_group3','172.100.9.3',3307,'test','111111','false','false','true',2,99,3,'hostS32',5,2,'false','false','false','false',1,1,1,1)                           | success   | dble_information |

      | conn_0 | false    | insert into DBLE_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) value ('hostM4','ha_group4','172.100.9.5',3307,'test','111111','false','true',1,99)                         | success        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (NAME,db_group,addr,port,USER,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) value ('hostM5','ha_group5','172.100.9.10',3307,'test','111111','false','true',1,99)                        | success        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (NAME,db_group,addr,port,USER,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) values ('hostS51','ha_group5','172.100.9.11',3307,'test','111111','false','false',0,99)                     | success        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (NAME,db_group,addr,port,USER,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count,read_weight) values ('hostS52','ha_group5','172.100.9.12',3307,'test','111111','false','false',0,99,3)       | success        | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM6',db_group='ha_group6',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9                              | success        | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM7',db_group='ha_group7',addr='172.100.9.3',port=3307,user='test',password_encrypt='UHH6o0jOcaXRYzvyQrUN/P5avdmyoxpHO8B54y7+RkiIC73G1qgFr5X+mewtlC6p/v7Gc/NXD7sPDFB/kPM5aA==',encrypt_configured='true',`primary`='true',min_conn_count=4,max_conn_count=9,id='hostM7'                  | success        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (NAME,db_group,addr,port,password_encrypt,USER,encrypt_configured,primary,max_conn_count,min_conn_count) value ('hostM12','ha_group12','172.100.9.1','3307','111111','test','false','true','100','9')                | success        | dble_information |
    ...
    Then check resultset "dble_db_instance_1" has lines with following column values
      ...
      | hostM1  | ha_group1  | 172.100.9.5  | 3307   | test   | false                | true      | false      | 10               | 1000             | 0              | hostM1  |
      | hostM2  | ha_group2  | 172.100.9.6  | 3307   | test   | false                | true      | false      | 10               | 1000             | 0              | hostM2  |
      | hostM3  | ha_group3  | 172.100.9.1  | 3307   | test   | false                | true      | true       | 10               | 1000             | 1              | hostM3  |
      | hostS31 | ha_group3  | 172.100.9.2  | 3307   | test   | false                | false     | false      | 1                | 10               | 2              | hostS31 |
      | hostS32 | ha_group3  | 172.100.9.3  | 3307   | test   | false                | false     | true       | 2                | 99               | 3              | hostS32 |
      | hostM4  | ha_group4  | 172.100.9.5  | 3307   | test   | false                | true      | false      | 1                | 99               | 0              | hostM4  |
      | hostS52 | ha_group5  | 172.100.9.12 | 3307   | test   | false                | false     | false      | 0                | 99               | 3              | hostS52 |
      | hostM5  | ha_group5  | 172.100.9.10 | 3307   | test   | false                | true      | false      | 1                | 99               | 0              | hostM5  |
      | hostS51 | ha_group5  | 172.100.9.11 | 3307   | test   | false                | false     | false      | 0                | 99               | 0              | hostS51 |
      | hostM6  | ha_group6  | 172.100.9.9  | 3307   | test   | false                | true      | false      | 4                | 9                | 0              | hostM6  |
      | hostM7  | ha_group7  | 172.100.9.3  | 3307   | test   | true                 | true      | false      | 4                | 9                | 0              | hostM7  |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout=-1                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout='abcd'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout='abcd'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis=-1                     |       | dble_information |
...
##      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis='abvd'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis=-1                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis='abcd'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout=-1                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout='abcd'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis='0B01'                 |               | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis=-1                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis='abcd'                 |               | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                                                                           | expect             | db               |
      | conn_0 | false   | insert into dble_db_instance set name='hostM8',db_group='ha_group8',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout=null                  | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout=null        | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM10',db_group='ha_group10',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis=null | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM11',db_group='ha_group11',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis=null   | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostS11',db_group='ha_group11',addr='172.100.9.10',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,idle_timeout=null                    | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B02',db_group='0B02',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis=null                    | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B03',db_group='0B03',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_create=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B04',db_group='0B04',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_borrow=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B05',db_group='0B05',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_return=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B051',db_group='0B05',addr='172.100.9.10',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,test_while_idle=null                         | success            | dble_information |
...
#DBLE0REQ-1127
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_instance #5
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false    | update dble_db_instance set addr='172.100.9.3' where db_group='ha_group3'                            | dbGroup[ha_group3]'s child url [172.100.9.3:3307]  duplicated!      | dble_information |
      #### addr
