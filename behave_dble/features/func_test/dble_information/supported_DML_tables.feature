...
## DBLE0REQ-1085
      ...
      | conn_0 | false   | insert into DBLE_db_group set name='0B05',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_timeout=-1                         | Insert failure.The reason is Column 'heartbeat_timeout' should be a positive integer greater than 0    | dble_information |
      ...
      | conn_0 | false   | insert into DBLE_db_group set name='0B25',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_retry=-1                         | Insert failure.The reason is Column 'heartbeat_retry' should be a positive integer greater than 0   | dble_information |
      ...
      | conn_0 | false   | insert into DBLE_db_group set name='0B07',heartbeat_stmt='select 5',rw_split_mode=1,delay_threshold=-2                         | Insert failure.The reason is Column 'delay_threshold' should be a positive integer greater than -1    | dble_information |
...
#DBLE0REQ-1101
      ...
      | conn_0 | false   | insert into dble_db_instance set name='null',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9        | Not Supported of Value EXPR :'null'          | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name=0B01,db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9          | Not Supported of Value EXPR :0B01            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name=' ',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9           | Not Supported of Value EXPR :' '             | dble_information |
       ####   db_group
      | conn_0 | false    | insert into dble_db_instance set name='a',db_group='ha_group0',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9           | Cannot add or update a child row: a logical foreign key 'db_group':ha_group0 constraint fails                 | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='b',db_group=-1,addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9                    | Cannot add or update a child row: a logical foreign key 'db_group':-1 constraint fails                        | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='c',db_group=1.3,addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9                   | Not Supported of Value EXPR :1.3            | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='c',db_group=0B01,addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9                  | Not Supported of Value EXPR :0B01           | dble_information |
       ####   addr
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr=1.3,port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9                | Not Supported of Value EXPR :1.3            | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr=0B01,port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9               | Not Supported of Value EXPR :0B01           | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='0B01',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9             | there are some dbInstance connection failed, pls check these dbInstance:{dbInstance[ha_group9.hostM9]}         | dble_information |
       ####   port
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='null',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9       | Not Supported of Value EXPR :'null'                | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user=-1,password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9           | there are some dbInstance connection failed, pls check these dbInstance:{dbInstance[ha_group9.hostM9]} | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user=1.3,password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9          | Not Supported of Value EXPR :1.3                   | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='null',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9         | Not Supported of Value EXPR :'null'         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt=1.3,encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9            | Not Supported of Value EXPR :1.3            | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt=-1,encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9             |  there are some dbInstance connection failed, pls check these dbInstance:{dbInstance[ha_group9.hostM9]}   | dble_information |
       ####   encrypt_configured
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured=null,`primary`='true',min_conn_count=1,max_conn_count=9       | user test password need to decrypt, but failed                                                    | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured=0B01,`primary`='true',min_conn_count=1,max_conn_count=9       | Not Supported of Value EXPR :0B01                                                                 | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='null',min_conn_count=1,max_conn_count=9     | Not Supported of Value EXPR :'null'         | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`=1.3,min_conn_count=1,max_conn_count=9        | Not Supported of Value EXPR :1.3            | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`=0B01,min_conn_count=1,max_conn_count=9       | Not Supported of Value EXPR :0B01           | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count='null',max_conn_count=9      | Not Supported of Value EXPR :'null'         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=' ',max_conn_count=9         | Not Supported of Value EXPR :' '            | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1.3,max_conn_count=9         | Not Supported of Value EXPR :1.3            | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=0B01,max_conn_count=9        | Not Supported of Value EXPR :0B01           | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count='0B01',max_conn_count=9      | Insert failure.The reason is incorrect integer value: '0B01'                          | dble_information |
       ####   max_conn_count
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count='null'      | Not Supported of Value EXPR :'null'         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=0B01        | Not Supported of Value EXPR :0B01           | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count='0B01'      | Insert failure.The reason is incorrect integer value: '0B01'                       | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=1.3         | Not Supported of Value EXPR :1.3            | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout=0                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout=-1                              |       | dble_information |
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout=0                              |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis=0                     |       | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis=0                     |       | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout='0B01'                 | property [ idleTimeout ] '0B01' data type should be long             | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout=0                     |       | dble_information |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,idle_timeout='abcd'                 | property [ idleTimeout ] 'abcd' data type should be long             | dble_information |
...
#      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis=0                     |       | dble_information |
      ...
      | conn_0 | true     | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_while_idle=1.3                   | Not Supported of Value EXPR :1.3                                                                         | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                                                                           | expect             | db               |
      | conn_0 | false   | insert into dble_db_instance set name='hostM8',db_group='ha_group8',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout=null                  | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout=null        | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM10',db_group='ha_group10',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis=null | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM11',db_group='ha_group11',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis=null   | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostS11',db_group='ha_group11',addr='172.100.9.10',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,idle_timeout=null                    | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B02',db_group='0B02',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis=null                    | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B03',db_group='0B03',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_create=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B04',db_group='0B04',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_borrow=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B05',db_group='0B05',addr='172.100.9.9',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_return=null                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B051',db_group='0B05',addr='172.100.9.10',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,test_while_idle=null                         | success            | dble_information |
...
#DBLE0REQ-1127
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_group #4
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=-1 where rw_split_mode = 1                            | Update failure.The reason is Column 'heartbeat_timeout' should be a positive integer greater than 0 | dble_information |
      #### heartbeat_retry
      ...
      | conn_0 | false   | update dble_db_group set heartbeat_retry=-1 where rw_split_mode = 1                            | Update failure.The reason is Column 'heartbeat_retry' should be a positive integer greater than 0 | dble_information |
      #### rw_split_mode
      ...
      | conn_0 | false   | update dble_db_group set delay_threshold=-2 where rw_split_mode = 1                            | Update failure.The reason is Column 'delay_threshold' should be a positive integer greater than -1 | dble_information |
      #### disable_ha
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_instance #5
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | update dble_db_instance set read_weight=3,id='test' where port > 3307                           | success | dble_information |
    ...
    Then check resultset "dble_db_instance_1" has lines with following column values
      ...
      | hostM9  | ha_group9  | 172.100.9.9  | 3306   | test   | false                | true      | false      | 1                | 1000             | 3              | test  |
      ...
      | 0B05    | 0B05       | 172.100.9.9  | 3306   | test   | false                | true      | false      | 1                | 1000             | 3              | test  |
      | 0B051   | 0B05       | 172.100.9.10 | 3306   | test   | false                | false     | false      | 1                | 1000             | 3              | test  |
      ...
      | hostM10 | ha_group10 | 172.100.9.9  | 3306   | test   | false                | true      | false      | 1                | 1000             | 3              | test  |
      ...
      | hostM8  | ha_group8  | 172.100.9.9  | 3306   | test   | false                | true      | false      | 1                | 1000             | 3              | test  |
      ...
      | hostM1  | ha_group1  | 172.100.9.5  | 3306   | test   | false                | true      | false      | 10               | 100              | 3              | test  |
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false    | update dble_db_instance set addr='172.100.9.3' where db_group='ha_group3'                            | dbGroup[ha_group3]'s child url [172.100.9.3:3306]  duplicated!      | dble_information |
      #### addr
...
#      | conn_0 | false   | update dble_db_instance set connection_timeout=0 where db_group='ha_group1'                 |                                                 | dble_information |
...
#      | conn_0 | false   | update dble_db_instance set connection_heartbeat_timeout=0 where db_group='ha_group1'                |                                                    | dble_information |
...
#      | conn_0 | false   | update dble_db_instance set time_between_eviction_runs_millis=0 where db_group='ha_group1'                 |                                                    | dble_information |
...
#      | conn_0 | false   | update dble_db_instance set evictor_shutdown_timeout_millis=0 where db_group='ha_group1'                |                                                    | dble_information |
       ####   idle_timeout
...
#      | conn_0 | false   | update dble_db_instance set idle_timeout=0 where db_group='ha_group1'                |                                                    | dble_information |
...
#      | conn_0 | false   | update dble_db_instance set heartbeat_period_millis=0 where db_group='ha_group1'                |                                                  | dble_information |
       ####   test_on_create
