...
# Created by maofei at 2020/9/23 change by quexiuping 2021/5/7
  ...
  Feature: test addition, deletion and modification of dble_information on the management side
   dble_db_group
   dble_db_instance
   dble_rw_split_entry:id /type/username/password_encrypt/encrypt_configured/conn_attr_key/conn_attr_value/white_ips/max_conn_count/blacklist/db_group


  @skip_restart
  Scenario: test the langreage of insert in dble manager   ---- dble_db_group  #1
    ##name / heartbeat_stmt / heartbeat_timeout / heartbeat_retry / heartbeat_keep_alive / rw_split_mode / delay_threshold / delay_period_millis / delay_database / disable_ha / active
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                        | expect             | db               |
      | conn_0 | false   | insert into DBLE_db_group set name='0B02',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_timeout=null | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B03',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_retry=null   | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B04',heartbeat_stmt='select 5',rw_split_mode=1,delay_threshold=null   | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B05',heartbeat_stmt='select 5',rw_split_mode=1,disable_ha=null        | success            | dble_information |
      | conn_0 | false   | select heartbeat_timeout from DBLE_db_group where name ='0B02'                                             | has{((0,),)}       | dble_information |
      | conn_0 | false   | select heartbeat_retry from DBLE_db_group where name ='0B03'                                               | has{((1,),)}       | dble_information |
      | conn_0 | false   | select delay_threshold from DBLE_db_group where name ='0B04'                                               | has{((-1,),)}      | dble_information |
      | conn_0 | false   | select disable_ha from DBLE_db_group where name ='0B05'                                                    | has{(('false',),)} | dble_information |
      #heartbeat_keep_alive  对应 db.xml中的字段keepAlive 由3.22.07增加 DBLE0REQ-1495
      | conn_0 | false   | insert into DBLE_db_group set name='ha_group20',heartbeat_stmt='select user',rw_split_mode=2,disable_ha='true', heartbeat_keep_alive=1      | success     | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='ha_group21',heartbeat_stmt='select user',rw_split_mode=2,disable_ha='true', heartbeat_keep_alive=null    | success     | dble_information |
      | conn_0 | false   | select heartbeat_keep_alive from DBLE_db_group where name ='ha_group21'                                                    | has{((60,),)} | dble_information |
  ...
  Scenario: test the langreage of insert in dble manager   ---- dble_db_instance  #2
    # name/db_group/addr/port/user/password_encrypt/encrypt_configured/primary/active_conn_count/idle_conn_count/read_conn_request/write_conn_request/disabled/database_type/db_district/db_data_center/
    # last_heartbeat_ack_timestamp/last_heartbeat_ack/heartbeat_status/heartbeat_failure_in_last_5min/min_conn_count/max_conn_count/read_weight/id/
    # connection_timeout/connection_heartbeat_timeout/test_on_create/test_on_borrow/test_on_return/test_while_idle/time_between_eviction_runs_millis/evictor_shutdown_timeout_millis/idle_timeout/heartbeat_period_millis/flow_high_level/flow_low_level
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                       | expect      | db               |
    ...
    Given execute single sql in "dble-1" in "admin" mode and save resultset in "dble_db_instance_1"
      | conn   | toClose | sql                            | db               |
      | conn_0 | true    | select name,db_group,addr,port,user,encrypt_configured,primary,disabled,min_conn_count,max_conn_count,read_weight,id,database_type,db_district,db_data_center from dble_db_instance            | dble_information |
    Then check resultset "dble_db_instance_1" has lines with following column values
      | name-0  | db_group-1 | addr-2      | port-3 | user-4 | encrypt_configured-5 | primary-6 | disabled-7 | min_conn_count-8 | max_conn_count-9 | read_weight-10 | id-11   | database_type-12| db_district-13    | db_data_center-14 |
      | hostM1  | ha_group1  | 172.100.9.5 | 3306   | test   | false                | true      | false      | 10               | 1000             | 0              | hostM1  | mysql           | None              | None              |
      | hostM2  | ha_group2  | 172.100.9.6 | 3306   | test   | false                | true      | false      | 10               | 1000             | 0              | hostM2  | mysql           | None              | None              |
      | hostM3  | ha_group3  | 172.100.9.6 | 3306   | test   | false                | true      | true       | 10               | 1000             | 1              | hostM3  | mysql           | None              | None              |
      | hostS31 | ha_group3  | 172.100.9.6 | 3307   | test   | false                | false     | false      | 1                | 10               | 2              | hostS31 | mysql           | None              | None              |
      | hostS32 | ha_group3  | 172.100.9.6 | 3308   | test   | false                | false     | true       | 2                | 99               | 3              | hostS32 | mysql           | None              | None              |
      | hostM4  | ha_group4  | 172.100.9.6 | 3307   | test   | false                | true      | false      | 1                | 99               | 0              | hostM4  | mysql           | None              | None              |
      | hostS52 | ha_group5  | 172.100.9.6 | 3308   | test   | false                | false     | false      | 0                | 99               | 3              | hostS52 | mysql           | None              | None              |
      | hostM5  | ha_group5  | 172.100.9.6 | 3306   | test   | false                | true      | false      | 1                | 99               | 0              | hostM5  | mysql           | None              | None              |
      | hostS51 | ha_group5  | 172.100.9.6 | 3307   | test   | false                | false     | false      | 0                | 99               | 0              | hostS51 | mysql           | None              | None              |
      | hostM6  | ha_group6  | 172.100.9.4 | 3306   | test   | false                | true      | false      | 4                | 9                | 0              | hostM6  | mysql           | None              | None              |
      | hostM7  | ha_group7  | 172.100.9.5 | 3306   | test   | true                 | true      | false      | 4                | 9                | 0              | hostM7  | mysql           | None              | None              |
      | hostM12 | ha_group12 | 172.100.9.1 | 3306   | test   | false                | true      | false      | 9                | 100              | 0              | hostM12 | mysql           | None              | None              |
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | insert into dble_db_instance set name='0B052',db_group='0B05',addr='172.100.9.4',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,db_district=null,db_data_center=null                          | success            | dble_information |
      | conn_0 | false   | select db_district,db_data_center from dble_db_instance where name ='0B052'                           | has{((None, None),)} | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B053',db_group='0B05',addr='172.100.9.5',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,db_district='abc',db_data_center='efg'                          | success            | dble_information |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_group #4
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=null where rw_split_mode = 1   | Update failure.The reason is Column 'heartbeat_keep_alive' should be an integer greater than or equal to 0! | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=null where rw_split_mode = 1             | success  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database=null where rw_split_mode = 1         | success  | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                 | expect   | db               |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=80 where name = 'ha_group11'                          | success  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=20,delay_database='db1' where name = 'ha_group11'      | success  | dble_information |
      | conn_0 | false   | select heartbeat_keep_alive,delay_period_millis,delay_database from dble_db_group where name = 'ha_group11'        | has{((80,20,'db1'),)}  | dble_information |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_instance #5
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | update dble_db_instance set flow_high_level=null where db_group='ha_group1'                      | Update failure.The reason is Column 'flow_high_level' should be an integer greater than 0!| dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=null where db_group='ha_group1'                       | Update failure.The reason is Column 'flow_low_level' should be an integer greater than 0!| dble_information |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_rw_split_entry #6
    ...
    Then check resultset "dble_rw_split_entry_1" has lines with following column values
      | id-0 | type-1    | username-2 | encrypt_configured-4 | conn_attr_key-5 | conn_attr_value-6 | white_ips-7    | max_conn_count-8 | blacklist-9 | db_group-10 |
      | 3    | conn_attr | rw1        | false                | tenant          | tenant1           | None           | 200              | None        | ha_group3   |
      | 4    | conn_attr | rw2        | false                | tenant          | tenant2           | None           | 200              | None        | ha_group4   |
      | 5    | conn_attr | rw3        | false                | tenant          | tenant3           | None           | 200              | None        | ha_group5   |
      | 6    | conn_attr | rw4        | false                | tenant          | tenant4           | None           | 200              | None        | ha_group6   |
      | 7    | username  | rw5        | true                 | None            | None              | None           | 100              | None        | ha_group4   |
      | 8    | username  | rw6        | false                | None            | None              | None           | 100              | None        | ha_group3   |
      | 9    | username  | rw7        | false                | None            | None              | None           | 100              | None        | ha_group4   |
      | 10   | username  | rw8        | false                | None            | None              | None           | 100              | None        | ha_group5   |
      | 11   | conn_attr | rw9        | false                | tenant          | tenant5           | None           | 200              | None        | ha_group6   |
      | 12   | username  | rw10       | false                | None            | None              | None           | 100              | None        | ha_group6   |
      | 13   | conn_attr | rw20       | false                | tenant          | tenant00          | None           | 200              | None        | ha_group7   |
  ...
  Scenario: test the langreage of delete in dble manager   ---- dble_db_group   dble_db_instance  dble_rw_split_entry #7
    ...
    Then check resultset "dble_db_group_1" has lines with following column values
      ...
      | ha_group7  | select @a         | 888                 | 100               | 60                     | 1               | 88                | -1                    | null             | false        | true      |
      | ha_group12 | select 7          | 888                 | 1                 | 60                     | 1               | 88                | -1                    | null             | false        | true      |
      | ha_group11 | select @a         | 888                 | 100               | 80                     | 1               | 88                | 20                    | db1              | false        | true      |
      | 0B02       | select @a         | 888                 | 100               | 60                     | 1               | 88                | -1                    | null             | false        | true      |
      | 0B04       | select @a         | 888                 | 100               | 60                     | 1               | 88                | -1                    | null             | false        | true      |
    ...
    Then check resultset "dble_rw_split_entry_1" has lines with following column values
      | id-0 | type-1    | username-2 | encrypt_configured-4 | conn_attr_key-5 | conn_attr_value-6 | white_ips-7   | max_conn_count-8 | blacklist-9 | db_group-10 |
      | 3    | conn_attr | rw2        | false                | tenant          | tenant2           | None          | 200              | None        | ha_group4   |
      | 4    | conn_attr | rw4        | false                | tenant          | tenant4           | None          | 200              | None        | ha_group6   |
      | 5    | username  | rw5        | true                 | None            | None              | None          | 100              | None        | ha_group4   |
      ...
      | 9    | conn_attr | rw9        | false                | tenant          | tenant5           | None          | 200              | None        | ha_group6   |
      | 10   | username  | rw10       | false                | None            | None              | None          | 100              | None        | ha_group6   |
      | 11   | conn_attr | rw20       | false                | tenant          | tenant00          | None          | 200              | None        | ha_group7   |
  ...
  Scenario: test unsupported syntax dble_db_group   #8
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                                    | expect                                                                                 | db               |
      ...
      | conn_0 | false   | insert into dble_db_group(name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value ('ha_group2','select 1',0,1,1,100,'false')                                             | Duplicate entry 'ha_group2' for key 'PRIMARY'                                          | dble_information |
   ...
   ###### heartbeat_keep_alive
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                | expect                                                                                         | db               |
      | conn_0 | false   | insert into DBLE_db_group set name='0B00',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive=' '                        | Not Supported of Value EXPR :' '                                                               | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B01',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive='null'                     | Not Supported of Value EXPR :'null'                                                            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B03',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive=0B01                       | Not Supported of Value EXPR :0B01                                                              | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B04',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive='0B01'                     | Insert failure.The reason is incorrect integer value: '0B01'                                   | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='1B05',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive=-2                         | Insert failure.The reason is Column 'heartbeat_keep_alive' should be an integer greater than or equal to 0!     | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B06',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_keep_alive=1.5                        | Not Supported of Value EXPR :1.5                                                               | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                               | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                            | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                              | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'   | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                               | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=heartbeat_timeout*10  where rw_split_mode = 0         | Not Supported of Value EXPR :heartbeat_timeout * 10            | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                         | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_timeout=-1 where rw_split_mode = 0                            | Update failure.The reason is Column 'heartbeat_timeout' should be an integer greater than or equal to 0! | dble_information |
      #### heartbeat_retry
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                               | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                            | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                              | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'   | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                               | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=heartbeat_retry*10  where rw_split_mode = 0           | Not Supported of Value EXPR :heartbeat_retry * 10              | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                         | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_retry=-1 where rw_split_mode = 0                            | Update failure.The reason is Column 'heartbeat_retry' should be an integer greater than or equal to 0!  | dble_information |
      #### rw_split_mode
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set rw_split_mode=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=null where rw_split_mode = 0                          | Column 'rw_split_mode' cannot be null                              | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'       | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=rw_split_mode*10  where rw_split_mode = 0             | Not Supported of Value EXPR :rw_split_mode * 10                    | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=-1 where rw_split_mode = 0                            | Update failure.The reason is rwSplitMode should be between 0 and 3 | dble_information |
      | conn_0 | false   | update dble_db_group set rw_split_mode=4 where rw_split_mode = 0                             | Update failure.The reason is rwSplitMode should be between 0 and 3 | dble_information |
      #### delay_threshold
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set delay_threshold=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'       | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold=delay_threshold*10  where rw_split_mode = 0           | Not Supported of Value EXPR :delay_threshold * 10                  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
      | conn_0 | false   | update dble_db_group set delay_threshold=-2 where rw_split_mode = 0                            | Update failure.The reason is Column 'delay_threshold' should be an integer greater than or equal to -1! | dble_information |
      #### disable_ha
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set disable_ha=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha='0B01' where rw_split_mode = 0                        | Update failure.The reason is Column 'disable_ha' values only support 'false' or 'true' | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=disable_ha*10  where rw_split_mode = 0                | Not Supported of Value EXPR :disable_ha * 10                       | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
      | conn_0 | false   | update dble_db_group set disable_ha=-2 where rw_split_mode = 0                            | Update failure.The reason is Column 'disable_ha' values only support 'false' or 'true' | dble_information |
   #####delay_period_millis
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set delay_period_millis=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'       | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=delay_period_millis*10  where rw_split_mode = 0       | Not Supported of Value EXPR :delay_period_millis * 10              | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
      | conn_0 | false   | update dble_db_group set delay_period_millis=-2 where rw_split_mode = 0                            | Update failure.The reason is Column 'delay_period_millis' should be an integer greater than or equal to -1! | dble_information |
    #####delay_database
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set delay_database=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database=disable_ha*10  where rw_split_mode = 0                | Not Supported of Value EXPR :disable_ha * 10                       | dble_information |
      | conn_0 | false   | update dble_db_group set delay_database=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
    #####heartbeat_keep_alive
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=1.3 where rw_split_mode = 0                           | Not Supported of Value EXPR :1.3                                   | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive='null' where rw_split_mode = 0                        | Not Supported of Value EXPR :'null'                                | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=0B01 where rw_split_mode = 0                          | Not Supported of Value EXPR :0B01                                  | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive='0B01' where rw_split_mode = 0                        | Update failure.The reason is incorrect integer value: '0B01'       | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=' ' where rw_split_mode = 0                           | Not Supported of Value EXPR :' '                                   | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=delay_period_millis*10  where rw_split_mode = 0       | Not Supported of Value EXPR :delay_period_millis * 10              | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=SYSDATE()  where rw_split_mode = 0                    | Not Supported of Value EXPR :SYSDATE()                             | dble_information |
      | conn_0 | false   | update dble_db_group set heartbeat_keep_alive=-2 where rw_split_mode = 0                            | Update failure.The reason is Column 'heartbeat_keep_alive' should be an integer greater than or equal to 0 | dble_information |

    Then check "NullPointerException|exception occurred when the statistics were recorded|Exception processing" not exist in file "/opt/dble/logs/dble.log" in host "dble-1"


  Scenario: test unsupported syntax dble_db_instance   #9
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                   | expect      | db               |
      | conn_0 | false   | insert into dble_db_group (name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value ('ha_group9','select 1',60,1,1,-1,'false')                           | success     | dble_information |
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                      | expect      | db               |
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM2',db_group='ha_group2',addr='172.100.9.8',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9                                      | Duplicate entry 'hostM2-ha_group2' for key 'PRIMARY'                  | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) value ('hostS4','ha_group2','172.100.9.5',3307,'test','111111','false','true',1,99)                                 | Insert failure.The reason is dbGroup[ha_group2] has multi primary instance        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (name,db_group,addr,port,user,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) value ('hostS4','ha_group2','172.100.9.2',3307,'test','111111','false','true',1,99)                                 | Insert failure.The reason is dbGroup[ha_group2] has multi primary instance        | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.14',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9                                     | there are some dbInstance connection failed, pls check these dbInstance:{dbInstance[ha_group9.hostM9]}    | dble_information |
      #DBLE0REQ-1101
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                      | expect      | db               |
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.8',port='s',user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9           | java.lang.NumberFormatException: For input string: "s"                | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.8',port=s,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9             | Not Supported of Value EXPR :s                                        | dble_information |
  ...
  Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_district=' '                    | Not Supported of Value EXPR :' '                | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_district=0B01                   | Not Supported of Value EXPR :0B01                                     | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_district=1.3                    | Not Supported of Value EXPR :1.3                                      | dble_information |
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                      | expect      | db               |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_data_center='null'                | Not Supported of Value EXPR :'null'                                                                      | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_data_center=' '                   | Not Supported of Value EXPR :' '                                                                         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_data_center=0B01                  | Not Supported of Value EXPR :0B01                                                                        | dble_information |
      | conn_0 | true     | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,db_data_center=1.3                   | Not Supported of Value EXPR :1.3                                                                         | dble_information |
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                      | expect      | db               |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level='null'                | Not Supported of Value EXPR :'null'                                                                      | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level=' '                   | Not Supported of Value EXPR :' '                                                                         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level='0B01'                | Insert failure.The reason is incorrect integer value: '0B01'              | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level=0B01                  | Not Supported of Value EXPR :0B01                                                                        | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level=-1                    | Insert failure.The reason is Column 'flow_high_level' should be an integer greater than 0!               | dble_information |
      | conn_0 | true     | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_high_level=1.3                   | Not Supported of Value EXPR :1.3                                                                         | dble_information |
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                      | expect      | db               |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_low_level='null'                | Not Supported of Value EXPR :'null'                                                                      | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_low_level=' '                   | Not Supported of Value EXPR :' '                                                                         | dble_information |
      | conn_0 | false    | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.9',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,flow_low_level='0B01'                | Insert failure.The reason is incorrect integer value: '0B01'       | dble_information |
...
#      | conn_0 | false    | update dble_db_instance set addr='172.100.9.1' where db_group='ha_group3'                            | dbGroup[ha_group3]'s child url [172.100.9.6:3308]  duplicated!      | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
     ...
     Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_instance set db_district=1.3 where db_group='ha_group1'               | Not Supported of Value EXPR :1.3                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set db_district='null' where db_group='ha_group1'            | Not Supported of Value EXPR :'null'                                                                               | dble_information |
      | conn_0 | false   | update dble_db_instance set db_district=0B01 where db_group='ha_group1'              | Not Supported of Value EXPR :0B01                                                                                 | dble_information |
      | conn_0 | false   | update dble_db_instance set db_district=' ' where db_group='ha_group1'               | Not Supported of Value EXPR :' '                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set db_district=user*10  where db_group='ha_group1'          | Not Supported of Value EXPR :user * 10                                                                            | dble_information |
      | conn_0 | false   | update dble_db_instance set db_district=SYSDATE()  where db_group='ha_group1'        | Not Supported of Value EXPR :SYSDATE()                                                                            | dble_information |

     Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_instance set db_data_center=1.3 where db_group='ha_group1'               | Not Supported of Value EXPR :1.3                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set db_data_center='null' where db_group='ha_group1'            | Not Supported of Value EXPR :'null'                                                                               | dble_information |
      | conn_0 | false   | update dble_db_instance set db_data_center=0B01 where db_group='ha_group1'              | Not Supported of Value EXPR :0B01                                                                                 | dble_information |
      | conn_0 | false   | update dble_db_instance set db_data_center=' ' where db_group='ha_group1'               | Not Supported of Value EXPR :' '                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set db_data_center=user*10  where db_group='ha_group1'          | Not Supported of Value EXPR :user * 10                                                                            | dble_information |
      | conn_0 | false   | update dble_db_instance set db_data_center=SYSDATE()  where db_group='ha_group1'        | Not Supported of Value EXPR :SYSDATE()                                                                            | dble_information |

    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_instance set flow_high_level=1.3 where db_group='ha_group1'               | Not Supported of Value EXPR :1.3                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_high_level='null' where db_group='ha_group1'            | Not Supported of Value EXPR :'null'                                                                               | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_high_level=0B01 where db_group='ha_group1'              | Not Supported of Value EXPR :0B01                                                                                 | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_high_level='0B01' where db_group='ha_group1'            | Update failure.The reason is incorrect integer value: '0B01'                       | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_high_level=' ' where db_group='ha_group1'               | Not Supported of Value EXPR :' '                                                                                  | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose  | sql                   | expect               | db               |
      | conn_0 | false   | update dble_db_instance set flow_low_level=1.3 where db_group='ha_group1'               | Not Supported of Value EXPR :1.3                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level='null' where db_group='ha_group1'            | Not Supported of Value EXPR :'null'                                                                               | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=0B01 where db_group='ha_group1'              | Not Supported of Value EXPR :0B01                                                                                 | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level='0B01' where db_group='ha_group1'            | Update failure.The reason is incorrect integer value: '0B01'                       | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=' ' where db_group='ha_group1'               | Not Supported of Value EXPR :' '                                                                                  | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=user*10  where db_group='ha_group1'          | Not Supported of Value EXPR :user * 10                                                                            | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=SYSDATE()  where db_group='ha_group1'        | Not Supported of Value EXPR :SYSDATE()                                                                            | dble_information |
      | conn_0 | false   | update dble_db_instance set flow_low_level=-2 where db_group='ha_group1'                | Update failure.The reason is Column 'flow_low_level' should be an integer greater than 0!       | dble_information |

    Then check "NullPointerException|exception occurred when the statistics were recorded|Exception processing" not exist in file "/opt/dble/logs/dble.log" in host "dble-1"


  Scenario: test unsupported syntax dble_rw_split_entry   #10
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                   | expect      | db               |
      | conn_0 | false   | insert into dble_db_group (name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value ('ha_group6','select 1',60,1,1,-1,'false')                           | success     | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM6',db_group='ha_group6',addr='172.100.9.4',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=4,max_conn_count=9                              | success        | dble_information |
      | conn_0 | false   | insert into Dble_information.dble_rw_split_entry (username,password_encrypt,encrypt_configured,conn_attr_key,conn_attr_value,white_ips,max_conn_count,db_group) value ('rw1','111111','false','tenant','tenant1','172.100.9.7-172.100.9.3',0,'ha_group6')            | success        | dble_information |
      | conn_0 | false   | insert into dble_rw_split_entry set username='rw10',password_encrypt='111111',encrypt_configured='false',max_conn_count='100',db_group='ha_group6'                                                                                                                   | success        | dble_information |
#      | conn_0 | false   | insert into Dble_information.dble_rw_split_entry (username,password_encrypt,encrypt_configured,conn_attr_key,conn_attr_value,white_ips,max_conn_count,db_group) value ('rw4','111111','false','tenant','tenant4','172.100.9.7-172.100.9.3',0,'ha_group6')            | success        | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      ...
      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,conn_attr_key,conn_attr_value,white_ips,max_conn_count,db_group) value ('rw1','111111','false','tenant','tenant1','%.%.%.1','100','ha_group6')      | Duplicate entry 'rw1-tenant-tenant1'for logical unique 'username-conn_attr_key-conn_attr_value'        | dble_information |
