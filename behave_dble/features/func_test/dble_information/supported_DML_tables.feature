...
#      | conn_0 | false   | insert into dble_db_group (name,heartbeat_timeout,heartbeat_stmt,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value('ha_group12',100,'select 7',1,3,1000,'false')                        | success     | dble_information |
      | conn_0 | false   | insert into dble_db_group (name,heartbeat_stmt,heartbeat_timeout,heartbeat_retry,rw_split_mode,delay_threshold,disable_ha) value('ha_group12','select 7',100,1,3,1000,'false')                        | success     | dble_information |
    ...
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                        | expect             | db               |
      | conn_0 | false   | insert into DBLE_db_group set name='0B02',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_timeout=0    | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B03',heartbeat_stmt='select 5',rw_split_mode=1,heartbeat_retry=1      | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B04',heartbeat_stmt='select 5',rw_split_mode=1,delay_threshold=-1     | success            | dble_information |
      | conn_0 | false   | insert into DBLE_db_group set name='0B05',heartbeat_stmt='select 5',rw_split_mode=1,disable_ha='false'     | success            | dble_information |
...
#      | conn_0 | false   | select disable_ha from DBLE_db_group where name ='0B05'                                                    | has{(('false',),)} | dble_information |
  ...
  Scenario: test the langreage of insert in dble manager   ---- dble_db_instance  #2
    # name/db_group/addr/port/user/password_encrypt/encrypt_configured/primary/active_conn_count/idle_conn_count/read_conn_request/write_conn_request/disabled/
    ...
    # connection_timeout/connection_heartbeat_timeout/test_on_create/test_on_borrow/test_on_return/test_while_idle/time_between_eviction_runs_millis/evictor_shutdown_timeout_millis/idle_timeout/heartbeat_period_millis
    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                       | expect      | db               |
      ...
      | conn_0 | false    | insert into dble_db_instance set name='hostM7',db_group='ha_group7',addr='172.100.9.4',port=3306,user='test',password_encrypt='UHH6o0jOcaXRYzvyQrUN/P5avdmyoxpHO8B54y7+RkiIC73G1qgFr5X+mewtlC6p/v7Gc/NXD7sPDFB/kPM5aA==',encrypt_configured='true',`primary`='true',min_conn_count=4,max_conn_count=9,id='hostM7'                  | success        | dble_information |
      | conn_0 | false    | insert into DBLE_db_instance (NAME,db_group,addr,port,USER,password_encrypt,encrypt_configured,primary,min_conn_count,max_conn_count) value ('hostM12','ha_group12','172.100.9.1','3306','test','111111','false','true','9','100')                | success        | dble_information |
    ...
    Then check resultset "dble_db_instance_1" has lines with following column values
      ...
      | hostM7  | ha_group7  | 172.100.9.4 | 3306   | test   | true                 | true      | false      | 4                | 9                | 0              | hostM7  |
    ...
    Then check following text exist "Y" in file "/opt/dble/logs/dble_admin_query.log" in host "dble-1" retry "5,2" times
      ...
      rwSplitMode\":1.*ha_group7.*name\":\"hostM7\",\"url\":\"172.100.9.4:3306
      rwSplitMode\":3.*ha_group12.*\"name\":\"hostM12\",\"url\":\"172.100.9.1:3306
      """

    Given execute sql in "dble-1" in "admin" mode
      | conn   | toClose | sql                                                                                                                                                                                                                                                           | expect             | db               |
      | conn_0 | false   | insert into dble_db_instance set name='hostM8',db_group='ha_group8',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_timeout=30000                  | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM9',db_group='ha_group9',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,connection_heartbeat_timeout=30000        | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM10',db_group='ha_group10',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,time_between_eviction_runs_millis=30000 | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostM11',db_group='ha_group11',addr='172.100.9.6',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,evictor_shutdown_timeout_millis=30000   | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='hostS11',db_group='ha_group11',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,idle_timeout=30000                     | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B02',db_group='0B02',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,heartbeat_period_millis=30000                    | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B03',db_group='0B03',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_create='false'                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B04',db_group='0B04',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_borrow='false'                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B05',db_group='0B05',addr='172.100.9.6',port=3306,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='true',min_conn_count=1,max_conn_count=9,test_on_return='false'                             | success            | dble_information |
      | conn_0 | false   | insert into dble_db_instance set name='0B051',db_group='0B05',addr='172.100.9.6',port=3307,user='test',password_encrypt='111111',encrypt_configured='false',`primary`='false',min_conn_count=1,max_conn_count=9,test_while_idle='false'                          | success            | dble_information |
...
#      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,max_conn_count,db_group) values ('rw6','111111','false','100','ha_group3'),('rw7','111111','false','100','ha_group4'),('rw8','111111','false','100','ha_group5')                       | success        | dble_information |
      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,max_conn_count,db_group) values ('rw6','111111','false','100','ha_group3')                       | success        | dble_information |
      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,max_conn_count,db_group) values ('rw7','111111','false','100','ha_group4')                      | success        | dble_information |
      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,max_conn_count,db_group) values ('rw8','111111','false','100','ha_group5')                       | success        | dble_information |
      ...
      | conn_0 | false   | insert into dble_rw_split_entry (username,password_encrypt,encrypt_configured,conn_attr_key,conn_attr_value,white_ips,max_conn_count,db_group) value ('rw20','111111','false','tenant','tenant00','%.%.%.1','100','ha_group7')                                       | success        | dble_information |
    ...
    Then check resultset "dble_rw_split_entry_1" has lines with following column values
      ...
      | 6    | conn_attr | rw4        | false                | tenant          | tenant4           | 172.100.9.7-172.100.9.3      | 0                | None        | ha_group6   |
  ...
  Scenario:  test the langreage of update in dble manager ----- dble_db_instance #5
    ...
    Then check resultset "dble_db_instance_1" has lines with following column values
      ...
      | hostM7  | ha_group7  | 172.100.9.4 | 3306   | test   | true                 | true      | false      | 4                | 1000             | 3              |
