...
Feature: xa_trancation: kill node before trancation rollback

  Scenario: begin trancation and insert data , kill one node before trancation rollback #1
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | test | 111111 | conn_0 | True    | drop table account    | success     | schema1 |
