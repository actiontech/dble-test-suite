...
#      | conn_0 | False   | select * from tb_a                                                                                                                                                                                     | length{(21)}                                                         | schema4 |
  ...
  Scenario: check update/delete  from .... syntax and some tables #3
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | conn_0 | False   | delete schema2.single_t2 from schema1.sharding_2_t1,schema2.single_t2 where db1.sharding_2_t1.id=2 and schema2.single_t2.id =2;         | db1.sharding_2_t1 not exists      | schema1 |
