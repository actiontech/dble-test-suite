...
Feature:
  ...
  @btrace
  Scenario: check 'kill @@ddl_lock where schema=? and table=?' work fine #1
    ...
    Then execute sql in "dble-1" in "admin" mode
      ...
      | root | 111111 | conn_1 | false    | reload @@metadata                                   | success                           |    |
    Then execute sql in "dble-2" in "admin" mode
      | user | passwd | conn   | toClose | sql                       | expect      | db |
    ...
    Then execute sql in "dble-1" in "user" mode
      ...
      | test | 111111 | conn_4 | false   | select * from test             | success | schema1 |
      ...
      | test | 111111 | conn_2 | false   | select * from test             | success | schema1 |
      | test | 111111 | conn_3 | false   | begin                          | success | schema1 |
      | test | 111111 | conn_3 | false   | select * from test             | success | schema1 |
