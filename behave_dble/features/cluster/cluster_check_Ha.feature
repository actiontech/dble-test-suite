...
Feature: test "ha" in zk cluster
  ...
  Scenario: prepare and when ClusterEnable=true && useOuterHa=true && needSyncHa=true, check "dbgroup"  #1
    ...
    Then check resultset "Res_A" has lines with following column values
      ...
      | ha_group2  | hostM2 | 172.100.9.2 | 3306   | W     | 0        | 1000   | false       |
      | ha_group2  | hostS1 | 172.100.9.2 | 3307   | R     | 0        | 1000   | false       |
      | ha_group2  | hostS2 | 172.100.9.2 | 3308   | R     | 0        | 1000   | false       |
  ...
  Scenario: when ClusterEnable=true && useOuterHa=true && needSyncHa=true ,check "dbinstance"  #2
    ...
    Then check following text exist "Y" in file "/opt/dble/conf/db.xml" in host "dble-1"
      ...
      <dbInstance name=\"hostM2\" url=\"172.100.9.2:3306\" password=\"111111\" user=\"test\" maxCon=\"1000\" minCon=\"10\" primary=\"false\"/>
      <dbInstance name=\"hostS1\" url=\"172.100.9.2:3307\" password=\"111111\" user=\"test\" maxCon=\"1000\" minCon=\"10\" disabled=\"true\" primary=\"false\"/>
      <dbInstance name=\"hostS2\" url=\"172.100.9.2:3308\" password=\"111111\" user=\"test\" maxCon=\"1000\" minCon=\"10\" primary=\"true\"/>
      """
    Then check following text exist "Y" in file "/opt/dble/conf/db.xml" in host "dble-2"
      """
      <dbInstance name=\"hostM2\" url=\"172.100.9.2:3306\" password=\"111111\" user=\"test\" maxCon=\"1000\" minCon=\"10\" primary=\"false\"/>
