...
Feature: test dble's config xml and table dble_config in dble_information to check json on cluster
  ...
  Scenario: test modify dble's config xml and reload dble check json on zk config #1
    ...
    Given delete file "/opt/dble/logs/dble_zk_sharding.log" on "dble-1"
    Given delete file "/opt/dble/logs/dble_zk_db.log" on "dble-2"
    Given delete file "/opt/dble/logs/dble_zk_user.log" on "dble-3"
    Given delete file "/opt/dble/logs/dble_zk_sequences.log" on "dble-3"
...
#    Given sleep "60" seconds
  ...
  Scenario: test dble_information dble_config error dml check json on zk config #4
    ...
    Then execute "admin" cmd  in "dble-1" at background
      | conn   | toClose | sql                         | db               |
      | conn_1 | True    | select * from dble_config   | dble_information |
    Then check following text exist "N" in file "/opt/dble/logs/dble_admin_query.log" in host "dble-1" retry "6,2" times
    """
    \"name\":\"ha_group4\"
    M111
    \"type\":\"rwSplitUser\"
    ...
    Then execute "admin" cmd  in "dble-2" at background
      | conn   | toClose | sql                         | db               |
      | conn_2 | True    | select * from dble_config   | dble_information |
    Then check following text exist "N" in file "/opt/dble/logs/dble_admin_query.log" in host "dble-2" retry "6,2" times
    """
    \"name\":\"ha_group4\"
    M111
    \"type\":\"rwSplitUser\"
    ...
    Then execute "admin" cmd  in "dble-3" at background
      | conn   | toClose | sql                         | db               |
      | conn_3 | True    | select * from dble_config   | dble_information |
    Then check following text exist "N" in file "/opt/dble/logs/dble_admin_query.log" in host "dble-3" retry "6,2" times
    """
    \"name\":\"ha_group4\"
    M111
    \"type\":\"rwSplitUser\"
  ...
  Scenario: test dble_information dble_config dml check json on zk config #5
    ...
    \"dbInstance\":\[
    {\"name\":\"hostM4\",\"url\":\"172.100.9.6:3307\",\"password\":\"111111\",\"user\":\"test\",\"maxCon\":89757,\"minCon\":1,\"usingDecrypt\":\"false\",\"disabled\":\"false\",\"readWeight\":\"0\",\"primary\":true,
    \"property\":\[
    {\"value\":\"30000\",\"name\":\"connectionTimeout\"},
    {\"value\":\"20\",\"name\":\"connectionHeartbeatTimeout\"},
    {\"value\":\"false\",\"name\":\"testOnCreate\"},
    ...
    <dbGroup rwSplitMode=\"0\" name=\"ha_group4\" delayThreshold=\"100\" disableHA=\"false\">
        ...
        <dbInstance name=\"hostM4\" url=\"172.100.9.6:3307\" password=\"111111\" user=\"test\" maxCon=\"89757\" minCon=\"1\" usingDecrypt=\"false\" disabled=\"false\" readWeight=\"0\" primary=\"true\">
            <property name=\"connectionTimeout\">30000</property>
            <property name=\"connectionHeartbeatTimeout\">20</property>
            <property name=\"testOnCreate\">false</property>
            <property name=\"testOnBorrow\">false</property>
  ...
  Scenario: test dble_information dble_config dml check json on zk config use btrace  #6
   ...
   #case dble-2 add btrace
    ...
    {\"name\":\"hostM3\",\"url\":\"172.100.9.1:3306\",\"password\":\"111111\",\"user\":\"test\",\"maxCon\":7544,\"minCon\":1,\"usingDecrypt\":\"false\",\"disabled\":\"false\",\"readWeight\":\"0\",\"primary\":true,
    """
    Then check following text exist "N" in file "/opt/dble/logs/dble_admin_query.log" in host "dble-3"
    """
    {\"type\":\"RwSplitUser\",\"properties\":{\"dbGroup\":\"ha_group3\",\"name\":\"rw1\",\"password\":\"111111\",\"usingDecrypt\":\"false\",\"maxCon\":100}
    {\"type\":\"RwSplitUser\",\"properties\":{\"dbGroup\":\"ha_group3\",\"name\":\"rw2\",\"password\":\"111111\",\"usingDecrypt\":\"false\",\"maxCon\":100}
    """
