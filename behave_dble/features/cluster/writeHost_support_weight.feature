...
#github issue #793
  ...
  Scenario: set parameter "readWeight" for writeHost in cluster, then reload #1
    ...
    <dbGroup rwSplitMode="2" name="ha_group2" delayThreshold="100" >
     ...
     <dbInstance name="hostM1" password="111111" url="172.100.9.6:3307" user="test" maxCon="9" minCon="3" primary="true" readWeight="3"/>
     <dbInstance name="hostM2" password="111111" url="172.100.9.2:3307" user="test" maxCon="9" minCon="3" readWeight="3"/>
     <dbInstance name="hostM3" password="111111" url="172.100.9.3:3307" user="test" maxCon="9" minCon="3" readWeight="3"/>
     </dbGroup>
    """
