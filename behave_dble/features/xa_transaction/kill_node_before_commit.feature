...
Feature: xa_transaction: kill node before transaction commit
  ...
  Scenario: begin transaction and insert data , kill one node before transaction commit #1
    Then execute sql in "dble-1" in "user" mode
      ...
      | test | 111111 | conn_0 | False   | insert into sharding_4_t1 (id, customerid, accountno, amount) values (1, 1,'a0301',0),(2,2,'a0601',0), (3,3,'a0301',0),(4,601,'a0601',0) | success     | schema1 |
