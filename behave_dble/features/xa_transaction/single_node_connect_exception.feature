# Created by Administrator at 2020/2/23
# 2.19.11.0#dble-7870
Feature: backend node disconnect,causing xa abnormal

  Scenario: backend node connection is abnormal, causing xa prepare is abnormal, transaction automatic rollback
    ...
    Then execute sql in "dble-1" in "user" mode
      | user | passwd | conn   | toClose | sql                                                     | expect      | db      |
      | test | 111111 | new    | True    | select * from sharding_4_t1                             | length{(0)} | schema1 |
...
#    Then execute sql in "dble-1" in "user" mode
#      | user | passwd | conn   | toClose | sql                                                     | expect      | db      |
#      | test | 111111 | new    | True    | select * from sharding_4_t1                             | rollback    | schema1 |
#      | test | 111111 | new    | true    | rollback                                                | success     | schema1 |
#      | test | 111111 | conn_1 | false   | begin                                                   | success     | schema1 |
#      | test | 111111 | conn_1 | false   | insert into sharding_4_t1 values(1,1),(2,2),(3,3),(4,4) | success     | schema1 |
#      | test | 111111 | conn_1 | false   | commit                                                  | success     | schema1 |
