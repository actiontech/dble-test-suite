...
if __name__ == "__main__":
    ...
    large_packet_test(16*1024*1024-1, conn, sqlContext1)
    large_packet_test(16*1024*1024, conn, sqlContext2)
    large_packet_test(16*1024*1024+1, conn, sqlContext3)
    large_packet_test(32*1024*1024-2, conn, sqlContext4)
    large_packet_test(32*1024*1024, conn, sqlContext5)
    large_packet_test(32*1024*1024+2, conn, sqlContext6)
    large_packet_test(36*1024*1024, conn, sqlContext7)
