...
def step_impl(context, host, mode_name="admin"):
    ...
    for row in context.table:
        ...
        cmd = u"nohup mysql -u{} -p{} -P{} -c -D{} -h{} -e\"{}\" >/tmp/dble_{}_query.log 2>&1 &".format(query_meta.user, query_meta.passwd, query_meta.port, query_meta.db, query_meta.ip, query_meta.sql,mode_name)
