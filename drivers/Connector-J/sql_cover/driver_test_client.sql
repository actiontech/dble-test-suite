...
insert into test_shard (id,R_REGIONKEY,R_NAME,t,b) values (1,1, 'a string','2012/12/31 11:30:45',0),(1,1, 'a string','2012/12/31 11:30:45',0),(null,null, null,null,null);
...
select * from test_shard where HEX(R_bit) like (select '%A%') escape (select '%') and HEX(R_bit) not like (select '%A%');
...
prepare stmt from 'insert into aly_test values(1,1,\'test中id为1\',1)';
execute stmt;
...
ALTER TABLE aly_test CHANGE name ID1 INTEGER  NOT NULL DEFAULT 10 COMMENT 'my column1';
...
/*charset*/
drop table if exists test_shard;
CREATE TABLE test_shard ( c1 CHAR(1) CHARACTER SET latin1, c2 CHAR(1) CHARACTER SET ascii,`c3` char(10) CHARACTER SET gbk, c4 char(10) character set utf8) DEFAULT CHARSET=utf8;
INSERT INTO test_shard VALUES ('a','b','你','我');
