...
1)access to the directory target/ where the "Jconnector-5.1.35.jar" file located
2)execute with the command: java -jar Jconnector-5.1.35.jar "test" "D:\autotest\dble\dble\conf\auto_dble_test.yaml" "driver_test_client.sql"