...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global,global_table2 where test_global.pad=global_table2.pad
...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global inner join global_table2 order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global cross join global_table2 order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global join global_table2 order by test_global.id,global_table2.id
...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global straight_join global_table2 order by test_global.id,global_table2.id
...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global left join global_table2 on test_global.pad=global_table2.pad order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global right join global_table2 on test_global.pad=global_table2.pad order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global left outer join global_table2 on test_global.pad=global_table2.pad order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global right outer join global_table2 on test_global.pad=global_table2.pad order by test_global.id,global_table2.id
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global left join global_table2 using(pad) order by test_global.id,global_table2.id
...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global natural left join global_table2
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global natural right join global_table2
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global natural left outer join global_table2
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global natural right outer join global_table2
...
select test_global.id,test_global.t_id,test_global.name,test_global.pad,global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from test_global left join global_table2 on test_global.pad=global_table2.pad and test_global.id>3 order by test_global.id,global_table2.id
#
#distinct(special_scene)
#
(select pad from test_global) union distinct (select pad from global_table2)
(select test_global.id,test_global.t_id,test_global.name,test_global.pad from test_global where id=2) union distinct (select global_table2.id,global_table2.o_id,global_table2.name,global_table2.pad from global_table2 where id=2)
