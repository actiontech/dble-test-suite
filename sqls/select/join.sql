...
select * from a_test a inner join (select * from a_order where pad>0) b order by a.id,b.id
select * from a_test a cross join (select * from a_order where pad>0) b order by a.id,b.id
select * from a_test a join (select * from a_order where pad>0) b order by a.id,b.id
select * from (select * from a_test where pad>0) a inner join (select * from a_order where pad>0) b order by a.id,b.id
select * from (select * from a_test where pad>0) a cross join (select * from a_order where pad>0) b order by a.id,b.id
select * from (select * from a_test where pad>0) a join (select * from a_order where pad>0) b order by a.id,b.id
select * from a_test a join (select * from a_order where pad>0) b on a.id<b.id and a.pad=b.pad order by a.id,b.id
select * from a_test a join (select * from a_order where pad>0) b  using(pad) order by a.id,b.id
