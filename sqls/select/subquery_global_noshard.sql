...
select * from (select * from test_global union select * from a_order_no_shard) a where a.id >3;
...
select * from test_global where pad<(select pad from a_order_no_shard where id=3);
select * from test_global having pad<(select pad from a_order_no_shard where id=3);
select a.id,b.id,b.pad,a.t_id from test_global a,(select * from a_order_no_shard where pad>3) b where a.t_id=b.o_id;
select id,name,(select count(*) from a_order_no_shard) count from test_global;
select * from test_global where pad like (select pad from a_order_no_shard where id=3);
...
select * from test_global,(select * from test_global where id>3 union select * from a_order_no_shard where id<2) a where a.id >3 and test_global.pad=a.pad;
...
select * from test_global where 'test_2'=(select name from a_order_no_shard where id=2)
select * from test_global where 5=(select count(*) from a_order_no_shard)
select * from test_global where 'test_2' like(select name from a_order_no_shard where id=2)
...
select * from test_global where (id,pad)=(select id,pad from a_order_no_shard limit 1)
select * from test_global where row(id,pad)=(select id,pad from a_order_no_shard limit 1)
