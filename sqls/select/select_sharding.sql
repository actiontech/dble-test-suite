...
select name,count(age) from aly_test group by name desc
select ID,name,age+10 as ages,IDcard from aly_test where id in (100) order by ID
select ID,name,age+10 as ages,IDcard from aly_test where id in (100) order by ages
select ID,name,count(age) from aly_test where id in (101) order by ID
select ID,name,count(age) as age from aly_test where id in (101)
select ID,name,count(age) as age from aly_test where id in (101) group by age
select ID,name,count(age) as age from aly_test where id in (101) group by age order by ID
select ID,name,count(age) as age,sum(age) total_age, avg(age) avg_age from aly_test where ID in (600) order by ID
select ID,name,count(age) as age,sum(age) total_age, avg(age) avg_age from aly_test where ID in (600) group by age
select ID,name,count(age) as age,sum(age) total_age, avg(age) avg_age from aly_test where ID in (600) group by age
select ID,name,age+10 as ages,IDcard from aly_test where id in (100,109) order by ID
...
select id,person from aly_test where id = 1 group by person
select person from aly_test where id > 1 group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id > 1 group by person
select person from aly_test where id like '1'
select person from aly_test where id like '1%' group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id like '%1' group by person
select person from aly_test where id not like '2%' group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id not like '%1' group by person
select person from aly_test where person  like 'm%' group by person
select postion from aly_test where person in (null) group by postion
select postion from aly_test where id in (1,2,3,4,5) group by postion
select postion from aly_test where id not in (1,2,3,4,5) group by postion
select postion, sum(postion) SUM from aly_test where id in (1,2,3,4,5) group by postion
select postion from aly_test where person in ('aaa','bbb','ccc') group by postion
select postion from aly_test where person not in ('aaa','bbb','ccc') group by postion
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where person in ('aaa','bbb','ccc') group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where person not in ('aaa','bbb','ccc') group by person
select person from aly_test where id between 1 and 4 group by person
select person from aly_test where id between 1 and 5 group by person
select person from aly_test where id between 1 and 50 group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id between 1 and 50 group by person
select person from aly_test where id is null group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id is null group by person
select person from aly_test where id is not null group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id is not null group by person
select person from aly_test where id is not null and id > 1 and person in ('aaa','bbb') group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where id is not null and id > 1 and person in ('aaa','bbb') group by person
select person from aly_test where ( id is not null and id > 1) or person in ('aaa','bbb') group by person
select person, count(person) count, avg(saleNum) as avg1, max(saleNum) as max, min(saleNum) min, sum(saleNum) sum from aly_test where (id is not null and id > 1) or person in ('aaa','bbb') group by person
select id,person from aly_test where id = 1 order by id
select id,person from aly_test where id = 1 order by id,person
select person from aly_test where id > 1 order by person limit 100
select person from aly_test where id like '1' order by person
select person from aly_test where id like '1%' order by person limit 100
...
select person from aly_test where id between 1 and 5 order by person
select person from aly_test where id between 1 and 50 order by person
select person,saleNum from aly_test where id between 1 and 51 order by person,saleNum
select person from aly_test where id is null order by person
select person,saleNum from aly_test where id is null order by person,saleNum
select person from aly_test where id is not null order by person limit 100
select person from aly_test where id is not null and id > 1 and person in ('aaa','bbb') order by person limit 100
