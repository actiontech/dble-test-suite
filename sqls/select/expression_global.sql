...
create table test_global (id int(11) primary key,R_REGIONKEY float,R_NAME varchar(50),R_COMMENT varchar(50))DEFAULT CHARSET=UTF8
insert into test_global (id,R_REGIONKEY,R_NAME,R_COMMENT) values (1,1, 'a string','test001'),(3,3, 'another string','test003'),(2,2, 'a\nstring','test002'),(4,4, '中','test004'),(5,5, 'a\'string\'','test005'),(6,6, 'a\""string\""','test006'),(7,7, 'a\bstring','test007'),(8,8, 'a\nstring','test008'),(9,9, 'a\rstring','test009'),(10,10, 'a\tstring','test010'),(11,11, 'a\zstring','test011'),(12,12, 'a\\string','test012'),(13,13, 'a\%string','test013'),(14,14, 'a\_string','test014'),(15,15, 'MySQL','test015'),(16,16, 'binary','test016'),(65,16, 'binary','test016'),(17,12345678901234567890123.4567890,17,17),(18,18, 'A','test018'),(19,19, '','test019')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a string'
select id,'a  string' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME="another string"
select id,"another string" from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a' ' ' 'string'
select id,'a' ' ' 'string' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=_utf8'中'
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,_utf8'中' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=_utf8'中'COLLATE utf8_danish_ci
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,_utf8'中'COLLATE utf8_danish_ci from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\'string\''
select id,'\'string\'',R_NAME from test_global
select * from test_global where R_NAME='a\"string\"'
select id,'\"string\"',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\bstring'
select id,'\b',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\nstring'
select id,'\n',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\rstring'
select id,'\r',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\tstring'
select id,'\t',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\zstring'
select id,'\z',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\\string'
select id,'\\',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\%string'
select id,'\%',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME='a\_string'
select id,'\_',R_NAME from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=(select X'4D7953514C')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,X'4D7953514C' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=(select CHARSET(X'4D7953514C'))
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id=(select X'41'+0)
select id,R_REGIONKEY+0 from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=(SELECT CHARSET(b''))
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,b'' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=_latin1 b'1000001'
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=_utf8 0b1000001 COLLATE utf8_danish_ci
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,_latin1 b'1000001' from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where R_NAME=B'1000001'
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id=(select true)
select true from test_global
select TRUE from test_global
select false from test_global
select FALSE from test_global
select R_NAME from test_global
select test_global.R_NAME from test_global
select mytest.test_global.R_NAME from test_global
select R_NAME as a from test_global
select R_NAME a from test_global
SELECT (@aa:=id) AS a, (@aa+3) AS b FROM test_global
SELECT @@global.sql_mode
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id=1||id=3
...
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 / B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 / B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (b'01' div B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(b'01' div B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 div B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 div B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (b'01' mod B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(b'01' mod B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 mod B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 mod B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (b'01' % B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(b'01' % B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 % B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 % B'11') from test_global
...
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 ^ B'11')
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 ^ B'11') from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (b'01' + interval 30 day)
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(b'01' + interval 30 day) from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 + interval 1 year)
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 + interval 1 year) from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (b'01' - interval 30 day)
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(b'01' - interval 30 day) from test_global
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT from test_global where id= (0b01 - interval 1 year)
select test_global.id,test_global.R_REGIONKEY,test_global.R_NAME,test_global.R_COMMENT,(0b01 - interval 1 year) from test_global
