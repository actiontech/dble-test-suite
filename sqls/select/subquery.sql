...
select a.id,b.id,b.pad,a.t_id from aly_test a,(select all * from aly_order) b where a.t_id=b.o_id
select a.id,b.id,b.pad,a.t_id from aly_test a,(select distinct * from aly_order) b where a.t_id=b.o_id
select * from (select * from aly_order a group by a.id) a
select * from (select pad,count(*) from aly_order a group by pad) a
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order having pad>3) b where a.t_id=b.o_id
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order where pad>3 order by id) b where a.t_id=b.o_id
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order order by id limit 3) b where a.t_id=b.o_id
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order order by id limit 3) b where a.t_id=b.o_id limit 2
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order where pad>3) b where a.t_id=b.o_id
select * from (select aly_order.pad from aly_test left join aly_order on aly_test.pad=aly_order.pad) a
select * from (select * from aly_test union select * from aly_order) a where a.id >3
select id,pad from aly_test where pad=(select min(id) from aly_order)
select (select name from aly_test order by id limit 1)
select (select name from aly_test order by id limit 1),id from aly_order order by id
select upper('test'),id from aly_order
...
select * from aly_test where pad<(select pad from aly_order where id=3)
select * from aly_test having pad<(select pad from aly_order where id=3)
select a.id,b.id,b.pad,a.t_id from aly_test a,(select * from aly_order where pad>3) b where a.t_id=b.o_id
select id,pad,name from (select * from aly_test where pad>2) as a
select * from (select * from aly_test where id<3) a,(select * from aly_order where id>3) b
...
select id,name,(select count(*) from aly_order) count from aly_test
select * from aly_test where pad like (select pad from aly_order where id=3)
...
select id,pad from aly_test where pad<(select pad from aly_test where id=2)
select * from aly_test where 'test_2'=(select name from aly_order where id=2)
select * from aly_test where 5=(select count(*) from aly_order)
select id,pad from aly_test where pad=(select pad from aly_test where id=2)
select id,pad from aly_test where pad>=(select pad from aly_test where id=2)
select id,pad from aly_test where pad<=(select pad from aly_test where id=2)
select id,pad from aly_test where pad<>(select pad from aly_test where id=2)
...
select * from aly_test where 'test_2' like(select name from aly_order where id=2)
select * from aly_test where name like(select name from aly_order where id=2)
...
select * from aly_test,(select * from aly_test where id>3 union select * from aly_order where id<2) a where a.id >3 and aly_test.pad=a.pad
select count(*) from (select * from aly_test where pad=(select pad from aly_order where id=1)) a
...
SELECT pad FROM aly_test AS x WHERE x.id = (SELECT pad FROM aly_order AS y WHERE x.id = (SELECT pad FROM a_manager WHERE y.id = a_manager.id))
select * from aly_test where (id,pad)=(select id,pad from aly_order limit 1)
select * from aly_test where row(id,pad)=(select id,pad from aly_order limit 1)
select id,name,pad from aly_test where (id,pad)in(select id,pad from aly_order)
select id,name,pad from aly_test where (1,1)in(select id,pad from aly_order)
SELECT pad FROM aly_test AS x WHERE x.id = (SELECT pad FROM aly_order AS y WHERE x.id = (SELECT pad FROM a_manager WHERE y.id = a_manager.id))
#
...
select * from (select pad,count(id) t from aly_test group by pad having t>1)a join (select pad,count(id) t from aly_order group by pad order by pad)b
select * from (select pad,count(id) t from aly_test group by pad having t>1)a join (select pad,count(id) t from aly_order group by pad order by pad)b where a.t>b.t
select a.pad,b.pad,count(*) from (select pad,count(id) t from aly_test group by pad having t>1)a join (select pad,count(id) t from aly_order group by pad order by pad)b group by b.pad order by b.pad
(select pad,count(id) t from aly_test group by pad having t>1)union(select pad,count(id) t from aly_order group by pad order by pad)
#
#order by(subquery)
#
select * from aly_test order by (select pad from aly_order order by id limit 1)
#select * from aly_test order by (select pad from aly_order limit 1)/*hang*/  #case for issue 13,waiting for fix
#
#clear tables
#
drop table if exists aly_test
