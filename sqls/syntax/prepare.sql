...
prepare pre_test from 'create view view_test as select aly_test.id,aly_test.name,aly_test.pad,aly_order.name as a_name from aly_test inner join aly_order'
execute pre_test
select * from view_test
drop view view_test
drop prepare pre_test
prepare pre_test from  'create view view_test as select a.id,b.id as b_id,b.pad,a.t_id from aly_test a,(select all * from aly_order) b where a.t_id=b.o_id'
execute pre_test
select * from view_test
drop view view_test
drop prepare pre_test
...
#contains select
#
prepare pre_test from 'select aly_test.id,aly_test.name,aly_test.pad,aly_order.name as a_name from aly_test inner join aly_order'
execute pre_test
drop prepare pre_test
prepare pre_test from 'select a.id,b.id as b_id,b.pad,a.t_id from aly_test a,(select all * from aly_order) b where a.t_id=b.o_id'
execute pre_test
drop prepare pre_test
