...
#      | test | 111111 | conn_0 | False   | select * from test1 join mytest.test1 using(id) | success |      |    #860
      | test | 111111 | conn_0 | False   | select * from test1 join testdb.test1 using(id) | Not unique table/alias |      |
#      | test | 111111 | conn_0 | False   | select * from mytest.test1 join testdb.test1 using(id) | success |      |    #860
